 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Up=g.forwardRef(({color:s="currentColor",size:u=24,strokeWidth:i=2,absoluteStrokeWidth:c,className:m="",children:h,iconNode:k,...O},w)=>g.createElement("svg",{ref:w,...Hp,width:u,height:u,stroke:s,strokeWidth:c?Number(i)*24/Number(u):i,className:vd("lucide",m),...O},[...k.map(([L,I])=>g.createElement(L,I)),...Array.isArray(h)?h:[h]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
