 ...
 */var rd;function Pp(){if(rd)return ze;rd=1;var s=Symbol.for("react.element"),d=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),g=Symbol.for("react.profiler"),p=Symbol.for("react.provider"),x=Symbol.for("react.context"),N=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),I=Symbol.for("react.memo"),L=Symbol.for("react.lazy"),C=Symbol.iterator;function F(h){return h===null||typeof h!="object"?null:(h=C&&h[C]||h["@@iterator"],typeof h=="function"?h:null)}var $={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},q=Object.assign,k={};function P(h,j,oe){this.props=h,this.context=j,this.refs=k,this.updater=oe||$}P.prototype.isReactComponent={},P.prototype.setState=function(h,j){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,h,j,"setState")},P.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function S(){}S.prototype=P.prototype;function M(h,j,oe){this.props=h,this.context=j,this.refs=k,this.updater=oe||$}var B=M.prototype=new S;B.constructor=M,q(B,P.prototype),B.isPureReactComponent=!0;var X=Array.isArray,W=Object.prototype.hasOwnProperty,R={current:null},E={key:!0,ref:!0,__self:!0,__source:!0};function K(h,j,oe){var le,U={},Y=null,de=null;if(j!=null)for(le in j.ref!==void 0&&(de=j.ref),j.key!==void 0&&(Y=""+j.key),j)W.call(j,le)&&!E.hasOwnProperty(le)&&(U[le]=j[le]);var be=arguments.length-2;if(be===1)U.children=oe;else if(1<be){for(var ye=Array(be),Oe=0;Oe<be;Oe++)ye[Oe]=arguments[Oe+2];U.children=ye}if(h&&h.defaultProps)for(le in be=h.defaultProps,be)U[le]===void 0&&(U[le]=be[le]);return{$$typeof:s,type:h,key:Y,ref:de,props:U,_owner:R.current}}function _(h,j){return{$$typeof:s,type:h.type,key:j,ref:h.ref,props:h.props,_owner:h._owner}}function A(h){return typeof h=="object"&&h!==null&&h.$$typeof===s}function ee(h){var j={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(oe){return j[oe]})}var ne=/\/+/g;function pe(h,j){return typeof h=="object"&&h!==null&&h.key!=null?ee(""+h.key):j.toString(36)}function Ce(h,j,oe,le,U){var Y=typeof h;(Y==="undefined"||Y==="boolean")&&(h=null);var de=!1;if(h===null)de=!0;else switch(Y){case"string":case"number":de=!0;break;case"object":switch(h.$$typeof){case s:case d:de=!0}}if(de)return de=h,U=U(de),h=le===""?"."+pe(de,0):le,X(U)?(oe="",h!=null&&(oe=h.replace(ne,"$&/")+"/"),Ce(U,j,oe,"",function(Oe){return Oe})):U!=null&&(A(U)&&(U=_(U,oe+(!U.key||de&&de.key===U.key?"":(""+U.key).replace(ne,"$&/")+"/")+h)),j.push(U)),1;if(de=0,le=le===""?".":le+":",X(h))for(var be=0;be<h.length;be++){Y=h[be];var ye=le+pe(Y,be);de+=Ce(Y,j,oe,ye,U)}else if(ye=F(h),typeof ye=="function")for(h=ye.call(h),be=0;!(Y=h.next()).done;)Y=Y.value,ye=le+pe(Y,be++),de+=Ce(Y,j,oe,ye,U);else if(Y==="object")throw j=String(h),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.");return de}function Ee(h,j,oe){if(h==null)return h;var le=[],U=0;return Ce(h,le,"","",function(Y){return j.call(oe,Y,U++)}),le}function Me(h){if(h._status===-1){var j=h._result;j=j(),j.then(function(oe){(h._status===0||h._status===-1)&&(h._status=1,h._result=oe)},function(oe){(h._status===0||h._status===-1)&&(h._status=2,h._result=oe)}),h._status===-1&&(h._status=0,h._result=j)}if(h._status===1)return h._result.default;throw h._result}var Pe={current:null},J={transition:null},ce={ReactCurrentDispatcher:Pe,ReactCurrentBatchConfig:J,ReactCurrentOwner:R};function te(){throw Error("act(...) is not supported in production builds of React.")}return ze.Children={map:Ee,forEach:function(h,j,oe){Ee(h,function(){j.apply(this,arguments)},oe)},count:function(h){var j=0;return Ee(h,function(){j++}),j},toArray:function(h){return Ee(h,function(j){return j})||[]},only:function(h){if(!A(h))throw Error("React.Children.only expected to receive a single React element child.");return h}},ze.Component=P,ze.Fragment=i,ze.Profiler=g,ze.PureComponent=M,ze.StrictMode=u,ze.Suspense=b,ze.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ce,ze.act=te,ze.cloneElement=function(h,j,oe){if(h==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+h+".");var le=q({},h.props),U=h.key,Y=h.ref,de=h._owner;if(j!=null){if(j.ref!==void 0&&(Y=j.ref,de=R.current),j.key!==void 0&&(U=""+j.key),h.type&&h.type.defaultProps)var be=h.type.defaultProps;for(ye in j)W.call(j,ye)&&!E.hasOwnProperty(ye)&&(le[ye]=j[ye]===void 0&&be!==void 0?be[ye]:j[ye])}var ye=arguments.length-2;if(ye===1)le.children=oe;else if(1<ye){be=Array(ye);for(var Oe=0;Oe<ye;Oe++)be[Oe]=arguments[Oe+2];le.children=be}return{$$typeof:s,type:h.type,key:U,ref:Y,props:le,_owner:de}},ze.createContext=function(h){return h={$$typeof:x,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},h.Provider={$$typeof:p,_context:h},h.Consumer=h},ze.createElement=K,ze.createFactory=function(h){var j=K.bind(null,h);return j.type=h,j},ze.createRef=function(){return{current:null}},ze.forwardRef=function(h){return{$$typeof:N,render:h}},ze.isValidElement=A,ze.lazy=function(h){return{$$typeof:L,_payload:{_status:-1,_result:h},_init:Me}},ze.memo=function(h,j){return{$$typeof:I,type:h,compare:j===void 0?null:j}},ze.startTransition=function(h){var j=J.transition;J.transition={};try{h()}finally{J.transition=j}},ze.unstable_act=te,ze.useCallback=function(h,j){return Pe.current.useCallback(h,j)},ze.useContext=function(h){return Pe.current.useContext(h)},ze.useDebugValue=function(){},ze.useDeferredValue=function(h){return Pe.current.useDeferredValue(h)},ze.useEffect=function(h,j){return Pe.current.useEffect(h,j)},ze.useId=function(){return Pe.current.useId()},ze.useImperativeHandle=function(h,j,oe){return Pe.current.useImperativeHandle(h,j,oe)},ze.useInsertionEffect=function(h,j){return Pe.current.useInsertionEffect(h,j)},ze.useLayoutEffect=function(h,j){return Pe.current.useLayoutEffect(h,j)},ze.useMemo=function(h,j){return Pe.current.useMemo(h,j)},ze.useReducer=function(h,j,oe){return Pe.current.useReducer(h,j,oe)},ze.useRef=function(h){return Pe.current.useRef(h)},ze.useState=function(h){return Pe.current.useState(h)},ze.useSyncExternalStore=function(h,j,oe){return Pe.current.useSyncExternalStore(h,j,oe)},ze.useTransition=function(){return Pe.current.useTransition()},ze.version="18.3.1",ze}var td;function gs(){return td||(td=1,ds.exports=Pp()),ds.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var od;function Ep(){if(od)return ln;od=1;var s=gs(),d=Symbol.for("react.element"),i=Symbol.for("react.fragment"),u=Object.prototype.hasOwnProperty,g=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};function x(N,b,I){var L,C={},F=null,$=null;I!==void 0&&(F=""+I),b.key!==void 0&&(F=""+b.key),b.ref!==void 0&&($=b.ref);for(L in b)u.call(b,L)&&!p.hasOwnProperty(L)&&(C[L]=b[L]);if(N&&N.defaultProps)for(L in b=N.defaultProps,b)C[L]===void 0&&(C[L]=b[L]);return{$$typeof:d,type:N,key:F,ref:$,props:C,_owner:g.current}}return ln.Fragment=i,ln.jsx=x,ln.jsxs=x,ln}var nd;function Tp(){return nd||(nd=1,cs.exports=Ep()),cs.exports}var t=Tp(),bl={},us={exports:{}},Mr={},ps={exports:{}},hs={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ld;function zp(){return ld||(ld=1,(function(s){function d(J,ce){var te=J.length;J.push(ce);e:for(;0<te;){var h=te-1>>>1,j=J[h];if(0<g(j,ce))J[h]=ce,J[te]=j,te=h;else break e}}function i(J){return J.length===0?null:J[0]}function u(J){if(J.length===0)return null;var ce=J[0],te=J.pop();if(te!==ce){J[0]=te;e:for(var h=0,j=J.length,oe=j>>>1;h<oe;){var le=2*(h+1)-1,U=J[le],Y=le+1,de=J[Y];if(0>g(U,te))Y<j&&0>g(de,U)?(J[h]=de,J[Y]=te,h=Y):(J[h]=U,J[le]=te,h=le);else if(Y<j&&0>g(de,te))J[h]=de,J[Y]=te,h=Y;else break e}}return ce}function g(J,ce){var te=J.sortIndex-ce.sortIndex;return te!==0?te:J.id-ce.id}if(typeof performance=="object"&&typeof performance.now=="function"){var p=performance;s.unstable_now=function(){return p.now()}}else{var x=Date,N=x.now();s.unstable_now=function(){return x.now()-N}}var b=[],I=[],L=1,C=null,F=3,$=!1,q=!1,k=!1,P=typeof setTimeout=="function"?setTimeout:null,S=typeof clearTimeout=="function"?clearTimeout:null,M=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function B(J){for(var ce=i(I);ce!==null;){if(ce.callback===null)u(I);else if(ce.startTime<=J)u(I),ce.sortIndex=ce.expirationTime,d(b,ce);else break;ce=i(I)}}function X(J){if(k=!1,B(J),!q)if(i(b)!==null)q=!0,Me(W);else{var ce=i(I);ce!==null&&Pe(X,ce.startTime-J)}}function W(J,ce){q=!1,k&&(k=!1,S(K),K=-1),$=!0;var te=F;try{for(B(ce),C=i(b);C!==null&&(!(C.expirationTime>ce)||J&&!ee());){var h=C.callback;if(typeof h=="function"){C.callback=null,F=C.priorityLevel;var j=h(C.expirationTime<=ce);ce=s.unstable_now(),typeof j=="function"?C.callback=j:C===i(b)&&u(b),B(ce)}else u(b);C=i(b)}if(C!==null)var oe=!0;else{var le=i(I);le!==null&&Pe(X,le.startTime-ce),oe=!1}return oe}finally{C=null,F=te,$=!1}}var R=!1,E=null,K=-1,_=5,A=-1;function ee(){return!(s.unstable_now()-A<_)}function ne(){if(E!==null){var J=s.unstable_now();A=J;var ce=!0;try{ce=E(!0,J)}finally{ce?pe():(R=!1,E=null)}}else R=!1}var pe;if(typeof M=="function")pe=function(){M(ne)};else if(typeof MessageChannel<"u"){var Ce=new MessageChannel,Ee=Ce.port2;Ce.port1.onmessage=ne,pe=function(){Ee.postMessage(null)}}else pe=function(){P(ne,0)};function Me(J){E=J,R||(R=!0,pe())}function Pe(J,ce){K=P(function(){J(s.unstable_now())},ce)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(J){J.callback=null},s.unstable_continueExecution=function(){q||$||(q=!0,Me(W))},s.unstable_forceFrameRate=function(J){0>J||125<J?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_=0<J?Math.floor(1e3/J):5},s.unstable_getCurrentPriorityLevel=function(){return F},s.unstable_getFirstCallbackNode=function(){return i(b)},s.unstable_next=function(J){switch(F){case 1:case 2:case 3:var ce=3;break;default:ce=F}var te=F;F=ce;try{return J()}finally{F=te}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(J,ce){switch(J){case 1:case 2:case 3:case 4:case 5:break;default:J=3}var te=F;F=J;try{return ce()}finally{F=te}},s.unstable_scheduleCallback=function(J,ce,te){var h=s.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?h+te:h):te=h,J){case 1:var j=-1;break;case 2:j=250;break;case 5:j=1073741823;break;case 4:j=1e4;break;default:j=5e3}return j=te+j,J={id:L++,callback:ce,priorityLevel:J,startTime:te,expirationTime:j,sortIndex:-1},te>h?(J.sortIndex=te,d(I,J),i(b)===null&&J===i(I)&&(k?(S(K),K=-1):k=!0,Pe(X,te-h))):(J.sortIndex=j,d(b,J),q||$||(q=!0,Me(W))),J},s.unstable_shouldYield=ee,s.unstable_wrapCallback=function(J){var ce=F;return function(){var te=F;F=ce;try{return J.apply(this,arguments)}finally{F=te}}}})(hs)),hs}var ad;function Mp(){return ad||(ad=1,ps.exports=zp()),ps.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bp=f.forwardRef(({color:s="currentColor",size:d=24,strokeWidth:i=2,absoluteStrokeWidth:u,className:g="",children:p,iconNode:x,...N},b)=>f.createElement("svg",{ref:b,...Up,width:d,height:d,stroke:s,strokeWidth:u?Number(i)*24/Number(d):i,className:vd("lucide",g),...N},[...x.map(([I,L])=>f.createElement(I,L)),...Array.isArray(p)?p:[p]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
I HAVE READ THIS COVENANT NOT TO SUE, WAIVER, RELEASE, INFORMED CONSENT, ASSUMPTION OF RISK AND INDEMNITY AGREEMENT, FULLY UNDERSTAND ITS TERMS, UNDERSTAND THAT I HAVE GIVEN UP SUBSTANTIAL RIGHTS BY SIGNING IT, AND HAVE SIGNED IT FREELY AND VOLUNTARILY WITHOUT ANY INDUCEMENT, ASSURANCE OR GUARANTEE BEING MADE TO ME AND INTEND MY SIGNATURE TO BE A COMPLETE AND UNCONDITIONAL RELEASE OF RELIANCE AND ALL PARTIES MENTIONED HEREIN TO THE GREATEST EXTENT ALLOWED BY LAW. THIS IS A RELEASE OF LIABILITY; DO NOT SIGN THIS DOCUMENT IF YOU DO NOT UNDERSTAND OR DO NOT AGREE WITH ITS TERMS.`;function Eh({onNext:s,onBack:d,isMainVisitor:i=!0,initialData:u}){const[g,p]=f.useState(!u?.esignConsentTimestamp),[x,N]=f.useState(u?.esignConsentTimestamp),[b]=f.useState(()=>{if(u?.sessionId)return u.sessionId;let _=sessionStorage.getItem("checkInSessionId");return _||(_=crypto.randomUUID(),sessionStorage.setItem("checkInSessionId",_)),_}),[I]=f.useState(()=>u?.deviceInfo?u.deviceInfo:{userAgent:navigator.userAgent,screenWidth:window.screen.width,screenHeight:window.screen.height,deviceType:/Mobile|Tablet/i.test(navigator.userAgent)?"mobile":"desktop",timestamp:new Date().toISOString()}),[L,C]=f.useState(u?.agreed||!1),[F,$]=f.useState(u?.signature||""),[q,k]=f.useState(!1),[P,S]=f.useState(""),M=f.useRef(null);f.useEffect(()=>{const _=M.current;if(!_)return;const A=_.getContext("2d");if(A&&(_.width=_.offsetWidth*2,_.height=_.offsetHeight*2,A.scale(2,2),A.strokeStyle="#D4A736",A.lineWidth=2,A.lineCap="round",A.lineJoin="round",u?.signature)){const ee=new Image;ee.onload=()=>{A.drawImage(ee,0,0,_.offsetWidth,_.offsetHeight)},ee.src=u.signature}},[u]);const B=_=>{k(!0);const A=M.current;if(!A)return;const ee=A.getContext("2d");if(!ee)return;const ne=A.getBoundingClientRect(),pe=A.width/ne.width,Ce=A.height/ne.height,Ee="touches"in _?_.touches[0].clientX:_.clientX,Me="touches"in _?_.touches[0].clientY:_.clientY,Pe=(Ee-ne.left)*pe/2,J=(Me-ne.top)*Ce/2;ee.beginPath(),ee.moveTo(Pe,J)},X=_=>{if(!q)return;const A=M.current;if(!A)return;const ee=A.getContext("2d");if(!ee)return;const ne=A.getBoundingClientRect(),pe=A.width/ne.width,Ce=A.height/ne.height,Ee="touches"in _?_.touches[0].clientX:_.clientX,Me="touches"in _?_.touches[0].clientY:_.clientY,Pe=(Ee-ne.left)*pe/2,J=(Me-ne.top)*Ce/2;ee.lineTo(Pe,J),ee.stroke()},W=()=>{k(!1);const _=M.current;_&&$(_.toDataURL())},R=()=>{const _=M.current;if(!_)return;const A=_.getContext("2d");A&&(A.clearRect(0,0,_.width,_.height),$(""))},E=()=>{const _=new Date().toISOString();N(_),p(!1)},K=_=>{if(_.preventDefault(),S(""),!x){S("Electronic signature consent is required"),p(!0);return}if(!L){S("You must agree to the waiver to continue");return}if(!F){S("Please provide your signature");return}s({agreed:L,signature:F,esignConsentTimestamp:x,sessionId:b,deviceInfo:I})};return t.jsxs(t.Fragment,{children:[t.jsx(Sh,{isOpen:g,onConsent:E}),t.jsx("div",{className:"min-h-screen flex items-start justify-center p-4 sm:p-6 pt-8 pb-10",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-3xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsx("h1",{className:"text-center mb-2 text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:"Waiver Agreement"}),t.jsx("p",{className:"text-center mb-6 text-base sm:text-lg",style:{color:"var(--color-text-gray)"},children:i?"Please read and sign the waiver":"Please review and provide your signature"}),t.jsxs("form",{onSubmit:K,className:"space-y-4 sm:space-y-6",children:[t.jsx("div",{className:"p-4 sm:p-6 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",lineHeight:"1.6",fontSize:"13px"},children:t.jsx("div",{style:{whiteSpace:"pre-wrap"},children:Ph})}),t.jsxs("label",{className:"flex items-start gap-3 cursor-pointer",children:[t.jsx("input",{type:"checkbox",checked:L,onChange:_=>C(_.target.checked),className:"w-5 h-5 mt-0.5 flex-shrink-0",style:{accentColor:"var(--color-gold)"}}),t.jsx("span",{className:"text-sm sm:text-base",style:{color:"var(--color-text-white)"},children:"I have read and agree to the terms of the waiver"})]}),t.jsxs("div",{children:[t.jsxs("div",{className:"flex justify-between items-center mb-2",children:[t.jsx("label",{className:"text-sm sm:text-base",style:{color:"var(--color-text-white)"},children:"Signature *"}),t.jsx("button",{type:"button",onClick:R,className:"px-3 py-1 rounded text-sm",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Clear"})]}),t.jsx("canvas",{ref:M,onMouseDown:B,onMouseMove:X,onMouseUp:W,onMouseLeave:W,onTouchStart:B,onTouchMove:X,onTouchEnd:W,className:"w-full rounded-lg cursor-crosshair touch-none",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",height:"220px"}}),t.jsx("p",{className:"mt-2 text-xs sm:text-sm",style:{color:"var(--color-text-gray)"},children:"Sign above with your mouse or finger"})]}),P&&t.jsx("p",{className:"text-center text-sm",style:{color:"var(--color-error)"},children:P}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2",children:[t.jsx("button",{type:"button",onClick:d,className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{type:"submit",className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Continue"})]})]})]})})]})}function Th({onNext:s,onBack:d,visitorNumber:i,totalAdults:u,initialData:g,primaryVisitorName:p,takenNames:x}){const[N,b]=f.useState(""),[I,L]=f.useState(""),[C,F]=f.useState(""),[$,q]=f.useState(!1),k=f.useRef(null);f.useEffect(()=>{const R=k.current;if(!R)return;const E=R.getContext("2d");if(E)if(R.width=R.offsetWidth*2,R.height=R.offsetHeight*2,E.scale(2,2),E.strokeStyle="#D4A736",E.lineWidth=2,E.lineCap="round",E.lineJoin="round",E.clearRect(0,0,R.width,R.height),g){if(b(g.name),F(g.signature),g.signature){const K=new Image;K.onload=()=>{E.drawImage(K,0,0,R.offsetWidth,R.offsetHeight)},K.src=g.signature}}else b(""),F("")},[i,g]);const P=R=>R.split(" ").map(E=>E.charAt(0).toUpperCase()+E.slice(1).toLowerCase()).join(" "),S=R=>{q(!0);const E=k.current;if(!E)return;const K=E.getContext("2d");if(!K)return;const _=E.getBoundingClientRect(),A=E.width/_.width,ee=E.height/_.height,ne="touches"in R?R.touches[0].clientX:R.clientX,pe="touches"in R?R.touches[0].clientY:R.clientY,Ce=(ne-_.left)*A/2,Ee=(pe-_.top)*ee/2;K.beginPath(),K.moveTo(Ce,Ee)},M=R=>{if(!$)return;const E=k.current;if(!E)return;const K=E.getContext("2d");if(!K)return;const _=E.getBoundingClientRect(),A=E.width/_.width,ee=E.height/_.height,ne="touches"in R?R.touches[0].clientX:R.clientX,pe="touches"in R?R.touches[0].clientY:R.clientY,Ce=(ne-_.left)*A/2,Ee=(pe-_.top)*ee/2;K.lineTo(Ce,Ee),K.stroke()},B=()=>{q(!1);const R=k.current;R&&F(R.toDataURL())},X=()=>{const R=k.current;if(!R)return;const E=R.getContext("2d");E&&(E.clearRect(0,0,R.width,R.height),F(""))},W=R=>{if(R.preventDefault(),!N.trim()){alert("Please enter the visitor's name");return}const E=N.trim().toLowerCase();if([p,...x].map(_=>_.trim().toLowerCase()).includes(E)){L("It looks like you've entered your own name. Please enter the name of the additional visitor instead.");return}if(L(""),!C){alert("Please provide a signature");return}s({name:N.trim(),signature:C})};return t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4 sm:p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-2xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsxs("div",{className:"flex items-center justify-center gap-3 mb-3",children:[t.jsx(xh,{size:32,style:{color:"var(--color-gold)"}}),t.jsxs("h1",{className:"text-center text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:["Additional Visitor ",i," of ",u]})]}),t.jsx("p",{className:"text-center mb-4 text-base sm:text-lg",style:{color:"var(--color-text-gray)"},children:"Please provide name and signature"}),t.jsx("div",{className:"flex items-start gap-3 mb-6 p-4 rounded-lg",style:{backgroundColor:"rgba(212, 167, 54, 0.15)",border:"1px solid var(--color-gold)"},children:t.jsxs("p",{className:"text-sm sm:text-base",style:{color:"var(--color-gold)"},children:["Please hand the device to ",t.jsxs("strong",{children:["Visitor ",i]})," to enter their information."]})}),t.jsxs("form",{onSubmit:W,className:"space-y-6",children:[t.jsxs("div",{className:"space-y-2",children:[t.jsxs("label",{className:"block text-base",style:{color:"var(--color-text-white)"},children:["Visitor ",i,"'s Full Name"]}),t.jsx("input",{type:"text",value:N,onChange:R=>{L(""),b(P(R.target.value))},placeholder:`Enter Visitor ${i}'s full name`,required:!0,className:"w-full px-4 py-3 rounded-lg text-base",style:{backgroundColor:"var(--color-background)",border:I?"1px solid #ef4444":"1px solid var(--color-border)",color:"var(--color-text-white)"}}),I&&t.jsx("p",{className:"text-sm mt-1",style:{color:"#ef4444"},children:I})]}),t.jsxs("div",{className:"space-y-3",children:[t.jsx("label",{className:"block text-base",style:{color:"var(--color-text-white)"},children:"Signature"}),t.jsxs("div",{className:"relative rounded-lg overflow-hidden",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",height:"180px"},children:[t.jsx("canvas",{ref:k,className:"w-full h-full cursor-crosshair",style:{touchAction:"none"},onMouseDown:S,onMouseMove:M,onMouseUp:B,onMouseLeave:B,onTouchStart:S,onTouchMove:M,onTouchEnd:B,onTouchCancel:B}),!C&&t.jsx("div",{className:"absolute inset-0 flex items-center justify-center pointer-events-none",style:{color:"var(--color-text-gray)",fontSize:"16px"},children:"Sign here with your finger or mouse"})]}),t.jsx("button",{type:"button",onClick:X,className:"w-full py-2 rounded-lg text-sm transition-colors",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Clear Signature"})]}),t.jsx("div",{className:"text-center p-3 rounded-lg",style:{backgroundColor:"rgba(212, 167, 54, 0.1)"},children:t.jsxs("p",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:["Collecting signatures: ",i," of ",u," adults"]})}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 sm:gap-4",children:[t.jsx("button",{type:"button",onClick:d,className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{type:"submit",className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Continue"})]})]})]})})}function zh({onNext:s,onBack:d,numberOfMinors:i}){const[u,g]=f.useState(Array(i).fill("")),p=b=>b.split(" ").map(I=>I.charAt(0).toUpperCase()+I.slice(1).toLowerCase()).join(" "),x=(b,I)=>{const L=[...u];L[b]=p(I),g(L)},N=b=>{b.preventDefault();for(let I=0;I<u.length;I++)if(!u[I].trim()){alert(`Please enter the name for Minor ${I+1}`);return}s(u.map(I=>I.trim()))};return t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4 sm:p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-2xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsxs("div",{className:"flex items-center justify-center gap-3 mb-3",children:[t.jsx(Sd,{size:32,style:{color:"var(--color-gold)"}}),t.jsx("h1",{className:"text-center text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:"Minor Information"})]}),t.jsxs("p",{className:"text-center mb-6 text-base sm:text-lg",style:{color:"var(--color-text-gray)"},children:["Please provide the name",i>1?"s":""," of ",i===1?"the":"all"," minor",i>1?"s":""," visiting"]}),t.jsxs("form",{onSubmit:N,className:"space-y-5",children:[t.jsx("div",{className:"space-y-4",children:u.map((b,I)=>t.jsxs("div",{className:"space-y-2",children:[t.jsxs("label",{className:"block text-base",style:{color:"var(--color-text-white)"},children:["Minor ",I+1," Full Name"]}),t.jsx("input",{type:"text",value:b,onChange:L=>x(I,L.target.value),placeholder:`Enter name of minor ${I+1}`,required:!0,className:"w-full px-4 py-3 rounded-lg text-base",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]},I))}),t.jsx("div",{className:"p-4 rounded-lg",style:{backgroundColor:"rgba(212, 167, 54, 0.1)",border:"1px solid rgba(212, 167, 54, 0.3)"},children:t.jsx("p",{className:"text-sm text-center",style:{color:"var(--color-text-gray)"},children:"ℹ️ Signatures are not required for minors"})}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2",children:[t.jsx("button",{type:"button",onClick:d,className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{type:"submit",className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Submit"})]})]})]})})}function Mh({customerName:s,hasMinors:d,onReturnHome:i}){const[u,g]=f.useState(15),p=f.useRef(i);return f.useEffect(()=>{p.current=i},[i]),f.useEffect(()=>{const x=setInterval(()=>{g(N=>N<=1?(clearInterval(x),setTimeout(()=>p.current(),0),0):N-1)},1e3);return()=>clearInterval(x)},[]),t.jsx("div",{className:"min-h-screen flex items-center justify-center p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-2xl text-center",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"48px"},children:[t.jsx("div",{className:"flex justify-center mb-6",children:t.jsx(xs,{size:80,style:{color:"var(--color-success)"}})}),t.jsxs("h1",{className:"mb-4",style:{color:"var(--color-gold)"},children:["Thank You, ",s,"!"]}),t.jsx("p",{className:"mb-6",style:{color:"var(--color-text-white)",fontSize:"18px"},children:"Your check-in is complete. A member of our team will be with you shortly."}),d&&t.jsxs("div",{className:"flex items-start gap-3 mb-8 p-4 rounded-lg text-left",style:{backgroundColor:"rgba(234, 179, 8, 0.1)",border:"1px solid var(--color-gold)"},children:[t.jsx(hh,{size:24,style:{color:"var(--color-gold)",flexShrink:0,marginTop:"2px"}}),t.jsx("p",{style:{color:"var(--color-gold)",fontSize:"16px",fontWeight:500},children:"Caution: Children under 15 years old must stay in the waiting room."})]}),t.jsxs("p",{className:"mb-6",style:{color:"var(--color-text-gray)"},children:["Returning to home screen in ",t.jsx("span",{style:{color:"var(--color-gold)"},children:u})," seconds..."]}),t.jsx("button",{onClick:i,className:"px-8 py-4 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Return to Home"})]})})}function Oh({onLogin:s}){const[d,i]=f.useState(""),[u,g]=f.useState(""),[p,x]=f.useState(!1),[N,b]=f.useState(""),[I,L]=f.useState(!1),C=async F=>{if(F.preventDefault(),b(""),!d.trim()){b("Username is required");return}if(!u.trim()){b("Password is required");return}if(d==="staff"&&u==="reliance")s(d,"staff");else if(d==="pricing"&&u==="reliance")s(d,"pricing");else if(d==="analysis"&&u==="reliance")s(d,"analysis");else if(d==="staff2"&&u==="reliance")s(d,"staff2");else if(["katia","sarah","diane","sneha","dheeraj","ben","om","guest"].includes(d.toLowerCase())&&u==="Reliance159")s(d.toLowerCase(),"staff2");else if(d==="rating"&&u==="Reliance33")s(d,"rating");else if(d===u&&d.replace(/\D/g,"").length===10){const $=d.replace(/\D/g,"");L(!0);try{const q=await fetch("/api/customer/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:$})}),k=await q.json();q.ok?s(d,"customer",{token:k.data.authToken,checkInId:k.data.checkInId,customerName:k.data.customerName}):b(k.error||"No check-in found for this phone number.")}catch{b("Login failed. Please check your connection and try again.")}finally{L(!1)}}else b("Invalid username or password")};return t.jsx("div",{className:"min-h-screen flex items-center justify-center p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-md",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"48px"},children:[t.jsxs("div",{className:"text-center mb-8",children:[t.jsx("img",{src:Jt,alt:"Reliance Surfaces",className:"w-24 h-24 mx-auto mb-4 object-contain"}),t.jsx("h1",{style:{color:"var(--color-gold)"},children:"Reliance Surfaces"}),t.jsx("p",{style:{color:"var(--color-text-gray)"},children:"Login"})]}),t.jsxs("form",{onSubmit:C,className:"space-y-6",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-white)"},children:"Username"}),t.jsx("input",{type:"text",value:d,onChange:F=>i(F.target.value),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},placeholder:"Enter your username"})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-white)"},children:"Password"}),t.jsxs("div",{className:"relative",children:[t.jsx("input",{type:p?"text":"password",value:u,onChange:F=>g(F.target.value),className:"w-full px-4 py-3 rounded-lg pr-12",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},placeholder:"Enter your password"}),t.jsx("button",{type:"button",onClick:()=>x(!p),className:"absolute right-3 top-1/2 -translate-y-1/2",style:{color:"var(--color-text-gray)"},children:p?t.jsx(eh,{size:20}):t.jsx(vs,{size:20})})]})]}),N&&t.jsx("div",{className:"p-3 rounded-lg",style:{backgroundColor:"rgba(239, 68, 68, 0.1)",border:"1px solid var(--color-error)"},children:t.jsx("p",{className:"text-center",style:{color:"var(--color-error)"},children:N})}),t.jsx("button",{type:"submit",disabled:I,className:"w-full py-4 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)",opacity:I?.7:1},children:I?"Signing in…":"Sign In"})]})]})})}function ud(s,d){const[i,u]=f.useState(s);return f.useEffect(()=>{const g=setTimeout(()=>u(s),d);return()=>clearTimeout(g)},[s,d]),i}function ir(s,d){d===void 0&&(d={});var i=d.insertAt;if(s&&typeof document<"u"){var u=document.head||document.getElementsByTagName("head")[0],g=document.createElement("style");g.type="text/css",i==="top"&&u.firstChild?u.insertBefore(g,u.firstChild):u.appendChild(g),g.styleSheet?g.styleSheet.cssText=s:g.appendChild(document.createTextNode(s))}}ir(`.react-loading-indicator-normalize,
...
}`);var No=Array.from({length:4},(function(s,d){return"--slab-phase".concat(d+1,"-color")})),Jh=function(s){var d,i=Qh(s?.style,s?.size),u=i.styles,g=i.fontSize,p=s?.easing,x=Vh(s?.speedPlus,"3s").animationPeriod,N=(function(b){var I={};if(b instanceof Array){for(var L=Gh(b,No.length),C=0;C<L.length&&!(C>=4);C++)I[No[C]]=L[C];return I}try{if(typeof b!="string")throw new Error("Color String expected");for(var F=0;F<No.length;F++)I[No[F]]=b}catch($){for($ instanceof Error?console.warn("[".concat($.message,']: Received "').concat(typeof b,'" instead with value, ').concat(JSON.stringify(b))):console.warn("".concat(JSON.stringify(b)," received in <Slab /> indicator cannot be processed. Using default instead!")),F=0;F<No.length;F++)I[No[F]]=Td}return I})((d=s?.color)!==null&&d!==void 0?d:"");return Yr.createElement("span",{className:"rli-d-i-b slab-rli-bounding-box",style:it(it(it(it(it({},g&&{fontSize:g}),x&&{"--rli-animation-duration-unitless":parseFloat(x)}),p&&{"--rli-animation-function":p}),N),u),role:"status","aria-live":"polite","aria-label":"Loading"},Yr.createElement("span",{className:"rli-d-i-b slab-indicator"},Yr.createElement("span",{className:"slabs-wrapper"},Yr.createElement("span",{className:"slab"}),Yr.createElement("span",{className:"slab"}),Yr.createElement("span",{className:"slab"}),Yr.createElement("span",{className:"slab"}))),Yr.createElement(Kh,{staticText:!0,text:s?.text,textColor:s?.textColor}))};ir(`.lifeline-rli-bounding-box {
...
}`);Array.from({length:4},(function(s,d){return"--life-line-phase".concat(d+1,"-color")}));function cn({color:s="#ccb331",size:d="medium",text:i,fullScreen:u=!1}){const g=t.jsxs("div",{className:"flex flex-col items-center justify-center gap-3",children:[t.jsx(Jh,{color:s,size:d}),i&&t.jsx("p",{className:"text-sm animate-pulse",style:{color:"var(--color-text-gray, #aaa)"},children:i})]});return u?t.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center",style:{backgroundColor:"rgba(0,0,0,0.7)"},children:g}):t.jsx("div",{className:"flex items-center justify-center p-6",children:g})}function Zh({customer:s,onClose:d,onSubmit:i,onMarkAsHelped:u,onRevisit:g,staffUsername:p,isViewOnly:x,allCheckIns:N}){const[b,I]=f.useState(s.draft?.step||1),[L,C]=f.useState(s.draft?.editedCustomerData||{}),[F,$]=f.useState(()=>{const w=s.draft?.editedCustomerData?.firstName??s.firstName,se=s.draft?.editedCustomerData?.lastName??s.lastName;return[w,se].filter(Boolean).join(" ")}),q=w=>{$(w);const se=w.trim().split(/\s+/).filter(Boolean);C(Qe=>({...Qe,firstName:se[0]||w.trim(),lastName:se.slice(1).join(" ")}))},[k,P]=f.useState(s.draft?.selectedFabricator),[S,M]=f.useState(s.draft?.materials||[]),[B,X]=f.useState(s.currentlyHelpedBy||s.draft?.helpedBy||p),[W,R]=f.useState(s.draft?.selectionSheetNumber||""),[E,K]=f.useState(s.draft?.selectedFabricator?.companyName||""),[_,A]=f.useState(""),[ee,ne]=f.useState(!1),[pe,Ce]=f.useState(!1),Ee=ud(E,300),Me=ud(_,300),[Pe,J]=f.useState([]),[ce,te]=f.useState([]),[h,j]=f.useState(!1),[oe,le]=f.useState(!1),[U,Y]=f.useState(!1),[de,be]=f.useState([]),[ye,Oe]=f.useState(!1),[cr,Fr]=f.useState(!1),[wr,Ve]=f.useState(null);f.useEffect(()=>{s.currentlyHelpedBy&&X(s.currentlyHelpedBy)},[s.currentlyHelpedBy]),f.useEffect(()=>{const w=s.phones?.[0];w&&(Fr(!0),fetch(`/api/images/customer/${encodeURIComponent(w)}`).then(se=>se.json()).then(se=>{se.success&&Array.isArray(se.data)&&be(se.data.filter(Qe=>Qe.images.length>0))}).catch(()=>{}).finally(()=>Fr(!1)))},[s.phones]);const br=()=>({...s,...L});f.useEffect(()=>{if(Ee.length<3){J([]);return}j(!0),fetch(`/api/accounts/search?q=${encodeURIComponent(Ee)}`).then(w=>w.json()).then(w=>J(w.success?w.data:[])).catch(()=>J([])).finally(()=>j(!1))},[Ee]),f.useEffect(()=>{if(Me.length<3){te([]);return}le(!0),fetch(`/api/materials/search?q=${encodeURIComponent(Me)}`).then(w=>w.json()).then(w=>te(w.success?w.data:[])).catch(()=>te([])).finally(()=>le(!1))},[Me]);const jr=()=>{if(s.status==="waiting"){const w={step:b,editedCustomerData:L,selectedFabricator:k,materials:S,helpedBy:B,selectionSheetNumber:W,isHold:S.some(se=>se.hold),isRevisit:s.draft?.isRevisit,previousMaterialsCount:s.draft?.previousMaterialsCount};i(s.id,w),fetch(`/api/check-ins/${s.id}/draft`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({draftStep:b,materials:S,fabricator:k||null,helpedBy:B,selectionSheetNumber:W})}).catch(se=>console.warn("Draft save failed:",se))}d()},Lr=w=>{P(w),K(w.companyName),ne(!1),w.salesPerson&&C(se=>({...se,salesPerson:w.salesPerson}))},We=w=>{K(w),ne(!0),k&&w.toLowerCase()!==k.companyName.toLowerCase()&&!k.companyName.toLowerCase().startsWith(w.toLowerCase())&&w.length>=3&&P(void 0)},or=w=>{const se={id:Date.now().toString(),name:w,soldAs:"",size:{l:"",h:""},lot:"",location:"",quantity:1,finish:"Polished",hold:!1,slabNumbers:""};M([...S,se]),A(""),Ce(!1)},De=(w,se,Qe)=>{M(S.map(Te=>Te.id===w?{...Te,[se]:Qe}:Te))},Z=w=>{M(S.filter(se=>se.id!==w))},xe=async()=>{if(b!==3||U)return;Y(!0);const w={step:3,editedCustomerData:L,selectedFabricator:k,materials:S,helpedBy:B,selectionSheetNumber:W,isHold:S.some(se=>se.hold),isRevisit:s.draft?.isRevisit,previousMaterialsCount:s.draft?.previousMaterialsCount};try{await fetch(`/api/check-ins/${s.id}/complete`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({materials:S,selectedFabricator:k,helpedBy:B,selectionSheetNumber:W})})}catch(se){console.error("Complete API error:",se)}Y(!1),i(s.id,w),d()},je=()=>{if(!s.draft?.selectionSheetNumber)return!1;const w=N.filter(ge=>ge.firstName===s.firstName&&ge.lastName===s.lastName&&ge.status==="helped"&&ge.draft?.selectionSheetNumber),Te=s.draft.selectionSheetNumber.split(".")[0],Ue=w.filter(ge=>(ge.draft?.selectionSheetNumber||"").startsWith(Te));return Ue.sort((ge,Re)=>{const _e=ge.draft?.selectionSheetNumber||"",H=Re.draft?.selectionSheetNumber||"",me=_e.split("."),Ae=H.split("."),Be=parseInt(me[0])||0,lr=parseInt(Ae[0])||0;if(Be!==lr)return Be-lr;const hr=me.length>1?parseInt(me[1]):0,Or=Ae.length>1?parseInt(Ae[1]):0;return hr-Or}),Ue[Ue.length-1]?.id===s.id},ke=br();return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"fixed inset-0 flex items-center justify-center p-6 z-50",style:{backgroundColor:"rgba(0, 0, 0, 0.8)"},children:t.jsxs("div",{className:"w-full max-w-4xl max-h-[90vh] overflow-y-auto",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"32px"},children:[t.jsxs("div",{className:"flex justify-between items-start mb-6",children:[t.jsxs("div",{children:[t.jsx("h2",{style:{color:"var(--color-gold)"},children:[ke.firstName,ke.lastName].filter(Boolean).join(" ")}),t.jsxs("p",{style:{color:"var(--color-text-gray)",fontSize:"14px"},children:["Step ",b," of 3"]})]}),t.jsx("button",{onClick:jr,className:"p-2 rounded-lg hover:bg-opacity-50",style:{backgroundColor:"var(--color-background)",color:"var(--color-text-gray)"},children:t.jsx(ct,{size:24})})]}),t.jsx("div",{className:"flex gap-2 mb-8",children:[1,2,3].map(w=>t.jsx("div",{className:"flex-1 h-2 rounded-full",style:{backgroundColor:w<=b?"var(--color-gold)":"var(--color-border)"}},w))}),b===1&&t.jsxs("div",{className:"space-y-6",children:[t.jsx("h3",{style:{color:"var(--color-text-white)"},children:"Customer Details"}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Full Name"}),t.jsx("input",{type:"text",value:F,onChange:w=>q(w.target.value),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Street Address"}),t.jsx("input",{type:"text",value:L.street??ke.street,onChange:w=>C({...L,street:w.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Suite/Unit"}),t.jsx("input",{type:"text",value:L.suiteUnit??ke.suiteUnit,onChange:w=>C({...L,suiteUnit:w.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{className:"grid grid-cols-4 gap-4",children:[t.jsxs("div",{className:"col-span-2",children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"City"}),t.jsx("input",{type:"text",value:L.city??ke.city,onChange:w=>C({...L,city:w.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"State"}),t.jsx("input",{type:"text",value:L.state??ke.state,onChange:w=>C({...L,state:w.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"ZIP"}),t.jsx("input",{type:"text",value:L.zip??ke.zip,onChange:w=>C({...L,zip:w.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Country"}),t.jsxs("select",{value:L.country??ke.country,onChange:w=>C({...L,country:w.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"USA",children:"USA"}),t.jsx("option",{value:"CAN",children:"CAN"}),t.jsx("option",{value:"MEX",children:"MEX"})]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Phone Numbers"}),(L.phones??ke.phones).map((w,se)=>t.jsx("input",{type:"tel",value:w,onChange:Qe=>{const Te=[...L.phones??ke.phones];Te[se]=Qe.target.value,C({...L,phones:Te})},className:"w-full px-4 py-3 rounded-lg mb-2",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}},se))]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Email Addresses"}),(L.emails??ke.emails).map((w,se)=>t.jsx("input",{type:"email",value:w,onChange:Qe=>{const Te=[...L.emails??ke.emails];Te[se]=Qe.target.value,C({...L,emails:Te})},className:"w-full px-4 py-3 rounded-lg mb-2",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}},se))]}),ke.visitors&&ke.visitors.length>0?t.jsxs("div",{children:[t.jsxs("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:["All Visitors (",ke.visitors.length,")"]}),t.jsx("div",{className:"space-y-4",children:ke.visitors.filter(w=>w&&w.name).map((w,se)=>(console.log(`Visitor ${se}:`,{name:w.name,hasSignature:!!w.signature,signatureLength:w.signature?.length,isMinor:w.isMinor,isMain:w.isMain}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-background)",border:w.isMain?"2px solid var(--color-gold)":"1px solid var(--color-border)"},children:[t.jsxs("div",{className:"flex items-center gap-2 mb-3",children:[t.jsx("span",{style:{color:"var(--color-text-white)",fontSize:"15px",fontWeight:"500"},children:w.name}),w.isMain&&t.jsx("span",{className:"px-2 py-0.5 rounded text-xs",style:{backgroundColor:"rgba(212, 167, 54, 0.2)",color:"var(--color-gold)"},children:"Main"}),w.isMinor&&t.jsx("span",{className:"px-2 py-0.5 rounded text-xs",style:{backgroundColor:"rgba(100, 100, 100, 0.2)",color:"var(--color-text-gray)"},children:"Minor"})]}),w.signature&&w.signature.length>0?t.jsx("div",{className:"rounded",style:{backgroundColor:"rgba(0, 0, 0, 0.3)",padding:"8px"},children:t.jsx("img",{src:w.signature,alt:`${w.name}'s signature`,className:"w-full rounded",style:{maxHeight:"80px",objectFit:"contain"}})}):w.isMinor?t.jsx("div",{className:"rounded flex items-center justify-center",style:{backgroundColor:"rgba(0, 0, 0, 0.2)",padding:"12px",minHeight:"80px"},children:t.jsx("span",{style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"No signature (Minor)"})}):null]},se)))})]}):t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Waiver Signature"}),t.jsx("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-background)"},children:t.jsx("img",{src:ke.signature,alt:"Signature",className:"w-full rounded",style:{maxHeight:"150px",objectFit:"contain"}})})]}),t.jsxs("div",{className:"rounded-lg overflow-hidden",style:{border:"1px solid var(--color-border)"},children:[t.jsxs("button",{onClick:()=>Oe(w=>!w),className:"w-full flex items-center justify-between px-4 py-3",style:{backgroundColor:"var(--color-background)",color:"var(--color-text-white)",border:"none",cursor:"pointer"},children:[t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx(ys,{size:16,style:{color:"var(--color-gold)"}}),t.jsx("span",{children:"Uploaded Images"}),!cr&&t.jsx("span",{className:"px-2 py-0.5 rounded text-xs",style:{backgroundColor:"rgba(212,167,54,0.15)",color:"var(--color-gold)"},children:de.reduce((w,se)=>w+se.images.length,0)})]}),ye?t.jsx(kd,{size:16,style:{color:"var(--color-text-gray)"}}):t.jsx(bd,{size:16,style:{color:"var(--color-text-gray)"}})]}),ye&&t.jsx("div",{className:"p-4",style:{borderTop:"1px solid var(--color-border)"},children:cr?t.jsx(cn,{size:"small",color:"#ccb331"}):de.length===0?t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"No images uploaded."}):t.jsx("div",{className:"space-y-5",children:de.map(w=>t.jsxs("div",{children:[de.length>1&&t.jsxs("p",{className:"mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:["Visit: ",new Date(w.checkInTime).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})]}),t.jsx("div",{className:"grid gap-3",style:{gridTemplateColumns:"repeat(auto-fill, minmax(110px, 1fr))"},children:w.images.map(se=>t.jsxs("div",{className:"relative rounded-lg overflow-hidden",style:{aspectRatio:"1",border:"1px solid var(--color-border)",cursor:"pointer"},onClick:()=>Ve(se.image_url),children:[t.jsx("img",{src:se.image_url,alt:"Material",className:"w-full h-full object-cover"}),t.jsxs("div",{className:"absolute bottom-0 right-0 px-1.5 py-0.5 text-xs font-semibold rounded-tl-lg",style:{backgroundColor:"rgba(0,0,0,0.75)",color:"var(--color-gold)"},children:["×",se.quantity]})]},se.id))})]},w.checkInId))})})]})]}),b===2&&t.jsxs("div",{className:"space-y-6",children:[t.jsxs("div",{children:[t.jsx("h3",{style:{color:"var(--color-text-white)"},children:"Referral Information"}),t.jsx("div",{className:"mt-4 p-4 rounded-lg",style:{backgroundColor:"var(--color-background)"},children:ke.referralSources&&ke.referralSources.length>0?ke.referralSources.map((w,se)=>t.jsxs("div",{className:"mb-3",children:[t.jsxs("p",{style:{color:"var(--color-text-white)"},children:[t.jsx("span",{style:{color:"var(--color-gold)"},children:"•"})," ",w.type]}),w.name&&t.jsxs("p",{style:{color:"var(--color-text-gray)",fontSize:"14px",marginLeft:"20px"},children:["Name: ",w.name]}),w.phone&&t.jsxs("p",{style:{color:"var(--color-text-gray)",fontSize:"14px",marginLeft:"20px"},children:["Phone: ",w.phone]}),w.location&&t.jsxs("p",{style:{color:"var(--color-text-gray)",fontSize:"14px",marginLeft:"20px"},children:["Location: ",w.location]})]},se)):t.jsx("p",{style:{color:"var(--color-text-gray)"},children:"No referral information provided"})})]}),t.jsxs("div",{children:[t.jsx("h3",{style:{color:"var(--color-text-white)",marginBottom:"16px"},children:"Fabricator Selection *"}),t.jsxs("div",{className:"relative",children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Search by Company Name"}),t.jsx("input",{type:"text",value:E,onChange:w=>We(w.target.value),onFocus:()=>ne(!0),onBlur:()=>{setTimeout(()=>ne(!1),200)},className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${k?"var(--color-gold)":"var(--color-border)"}`,color:"var(--color-text-white)"},placeholder:"Type 3+ characters to search..."}),ee&&E.length>=3&&t.jsx("div",{className:"absolute z-10 w-full mt-1 rounded-lg overflow-hidden",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",maxHeight:"200px",overflowY:"auto"},children:h?t.jsxs("div",{className:"px-4 py-3 flex items-center gap-2",children:[t.jsx(cn,{size:"small",color:"#ccb331"}),t.jsx("span",{style:{color:"var(--color-text-gray)",fontSize:"13px"},children:"Searching..."})]}):Pe.length>0?Pe.map(w=>t.jsxs("button",{onClick:()=>Lr(w),className:"w-full text-left px-4 py-3 hover:bg-opacity-50",style:{backgroundColor:"transparent",color:"var(--color-text-white)",borderBottom:"1px solid var(--color-border)"},children:[t.jsx("div",{children:w.companyName}),t.jsxs("div",{style:{color:"var(--color-text-gray)",fontSize:"12px"},children:[w.city,", ",w.state]})]},w.id)):t.jsx("div",{className:"px-4 py-3",children:t.jsxs("p",{style:{color:"var(--color-text-gray)"},children:['No accounts found matching "',E,'"']})})}),E.length>0&&E.length<3&&t.jsx("p",{className:"text-sm mt-1",style:{color:"var(--color-text-gray)"},children:"Type at least 3 characters to search"})]})]}),k&&t.jsxs("div",{className:"p-6 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"2px solid var(--color-gold)"},children:[t.jsxs("div",{className:"flex items-center justify-between mb-4",children:[t.jsx("h4",{style:{color:"var(--color-gold)"},children:"Selected Fabricator"}),t.jsx("button",{onClick:()=>{P(void 0),K("")},className:"px-3 py-1 rounded text-sm",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Change"})]}),t.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Company Name"}),t.jsx("input",{type:"text",value:k.companyName,onChange:w=>P({...k,companyName:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Address"}),t.jsx("input",{type:"text",value:k.address,onChange:w=>P({...k,address:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"City"}),t.jsx("input",{type:"text",value:k.city,onChange:w=>P({...k,city:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"State"}),t.jsx("input",{type:"text",value:k.state,onChange:w=>P({...k,state:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"ZIP"}),t.jsx("input",{type:"text",value:k.zip,onChange:w=>P({...k,zip:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Sales Person"}),t.jsx("input",{type:"text",value:L.salesPerson??ke.salesPerson??"",onChange:w=>C({...L,salesPerson:w.target.value}),placeholder:"Sales person name",className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Phone 1"}),t.jsx("input",{type:"text",value:k.phone1,onChange:w=>P({...k,phone1:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Phone 2"}),t.jsx("input",{type:"text",value:k.phone2||"",onChange:w=>P({...k,phone2:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Mobile"}),t.jsx("input",{type:"text",value:k.mobile||"",onChange:w=>P({...k,mobile:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Email"}),t.jsx("input",{type:"email",value:k.email,onChange:w=>P({...k,email:w.target.value}),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]})]})]})]}),b===3&&t.jsxs("div",{className:"space-y-6",children:[s.draft?.isRevisit&&t.jsx("div",{className:"p-4 rounded-lg mb-4",style:{backgroundColor:"rgba(212, 167, 54, 0.1)",border:"1px solid var(--color-gold)"},children:t.jsxs("p",{style:{color:"var(--color-gold)",fontSize:"14px"},children:[t.jsx("strong",{children:"Re-visit Mode:"})," You can edit all materials. Use the ",t.jsx("strong",{children:"−"})," button when quantity is 1 to delete a material."]})}),t.jsxs("div",{children:[t.jsx("h3",{style:{color:"var(--color-text-white)"},children:"Materials / Selection Sheet"}),t.jsxs("div",{className:"relative mt-4",children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Search Materials"}),t.jsx("input",{type:"text",value:_,onChange:w=>{A(w.target.value),Ce(!0)},onFocus:()=>Ce(!0),disabled:x,className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:x?"not-allowed":"text",opacity:x?.6:1},placeholder:x?"View only mode":"Search for materials..."}),!x&&pe&&_.length>=3&&t.jsx("div",{className:"absolute z-10 w-full mt-1 rounded-lg overflow-hidden",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",maxHeight:"200px",overflowY:"auto"},children:oe?t.jsxs("div",{className:"px-4 py-3 flex items-center gap-2",children:[t.jsx(cn,{size:"small",color:"#ccb331"}),t.jsx("span",{style:{color:"var(--color-text-gray)",fontSize:"13px"},children:"Searching..."})]}):ce.length>0?ce.map(w=>t.jsxs("button",{onClick:()=>or(w.name),className:"w-full text-left px-4 py-3 hover:bg-opacity-50 flex items-center justify-between",style:{backgroundColor:"transparent",color:"var(--color-text-white)",borderBottom:"1px solid var(--color-border)"},children:[t.jsx("span",{children:w.name}),t.jsx(dn,{size:16,style:{color:"var(--color-gold)"}})]},w.id)):t.jsx("div",{className:"px-4 py-3",children:t.jsxs("p",{style:{color:"var(--color-text-gray)"},children:['No materials found matching "',_,'"']})})})]})]}),S.length>0&&t.jsx("div",{className:"overflow-x-auto",children:t.jsxs("table",{className:"w-full",style:{borderCollapse:"separate",borderSpacing:"0 10px"},children:[t.jsx("thead",{children:t.jsxs("tr",{style:{backgroundColor:"var(--color-background)"},children:[t.jsx("th",{className:"px-5 py-4 text-left",style:{color:"var(--color-gold)",fontSize:"15px",fontWeight:"600",width:"110px"},children:"Qty"}),t.jsx("th",{className:"px-5 py-4 text-left",style:{color:"var(--color-gold)",fontSize:"15px",fontWeight:"600",minWidth:"160px"},children:"Name"}),t.jsx("th",{className:"px-5 py-4 text-left",style:{color:"var(--color-gold)",fontSize:"15px",fontWeight:"600",minWidth:"130px"},children:"Sold As"}),t.jsx("th",{className:"px-5 py-4 text-left",style:{color:"var(--color-gold)",fontSize:"15px",fontWeight:"600",minWidth:"130px"},children:"Finish"}),t.jsx("th",{className:"px-5 py-4 text-left",style:{color:"var(--color-gold)",fontSize:"15px",fontWeight:"600",minWidth:"150px"},children:"Size (L x H)"}),t.jsx("th",{className:"px-5 py-4 text-left",style:{color:"var(--color-gold)",fontSize:"15px",fontWeight:"600",minWidth:"90px"},children:"Lot"}),t.jsx("th",{className:"px-5 py-4 text-left",style:{color:"var(--color-gold)",fontSize:"15px",fontWeight:"600",minWidth:"110px"},children:"Location"}),t.jsx("th",{className:"px-5 py-4 text-left",style:{color:"var(--color-gold)",fontSize:"15px",fontWeight:"600",minWidth:"110px"},children:"Hold"})]})}),t.jsx("tbody",{children:S.map((w,se)=>{const Qe=s.draft?.isRevisit&&se<(s.draft?.previousMaterialsCount||0);return t.jsxs("tr",{style:{backgroundColor:Qe?"rgba(100, 100, 100, 0.2)":"var(--color-background)",borderRadius:"8px"},children:[t.jsx("td",{className:"px-5 py-5",style:{borderTopLeftRadius:"8px",borderBottomLeftRadius:"8px"},children:t.jsxs("div",{className:"flex items-center gap-1.5",children:[t.jsx("button",{onClick:()=>{w.quantity===1?Z(w.id):De(w.id,"quantity",w.quantity-1)},disabled:x,className:"p-2 rounded",style:{backgroundColor:"var(--color-card)",color:"var(--color-text-white)",opacity:x?.5:1,cursor:x?"not-allowed":"pointer"},title:w.quantity===1?"Delete material":"Decrease quantity",children:t.jsx(wd,{size:16})}),t.jsx("span",{style:{color:"var(--color-text-white)",minWidth:"30px",textAlign:"center",fontSize:"15px",fontWeight:"500"},children:w.quantity}),t.jsx("button",{onClick:()=>De(w.id,"quantity",w.quantity+1),disabled:x,className:"p-2 rounded",style:{backgroundColor:"var(--color-card)",color:"var(--color-text-white)",opacity:x?.5:1,cursor:x?"not-allowed":"pointer"},children:t.jsx(dn,{size:16})})]})}),t.jsx("td",{className:"px-5 py-5",children:t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("span",{style:{color:"var(--color-text-white)",fontSize:"15px"},children:w.name}),Qe&&t.jsx("span",{className:"px-2 py-1 rounded text-xs",style:{backgroundColor:"var(--color-card)",color:"var(--color-text-gray)",border:"1px solid var(--color-border)"},children:"Previous"})]})}),t.jsx("td",{className:"px-5 py-5",children:t.jsx("input",{type:"text",value:w.soldAs||"",onChange:Te=>De(w.id,"soldAs",Te.target.value),disabled:x,placeholder:"Alternative",className:"w-full px-3 py-2.5 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px",opacity:x?.6:1,cursor:x?"not-allowed":"text"}})}),t.jsx("td",{className:"px-5 py-5",children:t.jsxs("select",{value:w.finish||"Polished",onChange:Te=>De(w.id,"finish",Te.target.value),disabled:x,className:"w-full px-3 py-2.5 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px",opacity:x?.6:1,cursor:x?"not-allowed":"pointer"},children:[t.jsx("option",{value:"Polished",children:"Polished"}),t.jsx("option",{value:"Honed",children:"Honed"}),t.jsx("option",{value:"Polished/Honed",children:"Polished/Honed"}),t.jsx("option",{value:"Leather",children:"Leather"}),t.jsx("option",{value:"Honed/Leather",children:"Honed/Leather"})]})}),t.jsx("td",{className:"px-5 py-5",children:t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("input",{type:"text",value:w.size?.l||"",onChange:Te=>De(w.id,"size",{...w.size||{l:"",h:""},l:Te.target.value}),disabled:x,placeholder:"L",className:"w-16 px-2 py-2.5 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px",textAlign:"center",opacity:x?.6:1,cursor:x?"not-allowed":"text"}}),t.jsx("span",{style:{color:"var(--color-gold)",fontWeight:"bold",fontSize:"16px"},children:"×"}),t.jsx("input",{type:"text",value:w.size?.h||"",onChange:Te=>De(w.id,"size",{...w.size||{l:"",h:""},h:Te.target.value}),disabled:x,placeholder:"H",className:"w-16 px-2 py-2.5 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px",textAlign:"center",opacity:x?.6:1,cursor:x?"not-allowed":"text"}})]})}),t.jsx("td",{className:"px-5 py-5",children:t.jsx("input",{type:"text",value:w.lot||"",onChange:Te=>De(w.id,"lot",Te.target.value),disabled:x,placeholder:"Lot #",className:"w-full px-3 py-2.5 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px",opacity:x?.6:1,cursor:x?"not-allowed":"text"}})}),t.jsx("td",{className:"px-5 py-5",children:t.jsx("input",{type:"text",value:w.location||"",onChange:Te=>De(w.id,"location",Te.target.value),disabled:x,placeholder:"Location",className:"w-full px-3 py-2.5 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px",opacity:x?.6:1,cursor:x?"not-allowed":"text"}})}),t.jsx("td",{className:"px-5 py-5",children:t.jsxs("div",{children:[t.jsxs("label",{className:"flex items-center gap-2 mb-2 cursor-pointer",children:[t.jsx("input",{type:"checkbox",checked:w.hold,onChange:Te=>De(w.id,"hold",Te.target.checked),disabled:x,className:"w-4 h-4 rounded",style:{accentColor:"var(--color-gold)",opacity:x?.5:1,cursor:x?"not-allowed":"pointer"}}),t.jsx("span",{style:{color:"var(--color-text-white)",fontSize:"14px"},children:"Hold"})]}),w.hold&&t.jsx("input",{type:"text",value:w.slabNumbers||"",onChange:Te=>De(w.id,"slabNumbers",Te.target.value),disabled:x,placeholder:"Slab #s",className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-gold)",color:"var(--color-text-white)",fontSize:"14px",opacity:x?.6:1,cursor:x?"not-allowed":"text"}})]})})]},w.id)})})]})}),t.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Helped By"}),t.jsx("div",{className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"rgba(100, 100, 100, 0.2)",border:"1px solid var(--color-gold)",color:"var(--color-text-white)"},children:B})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Selection Sheet Number"}),t.jsx("input",{type:"text",value:W,onChange:w=>R(w.target.value),readOnly:s.draft?.isRevisit||x,placeholder:"e.g. 800, 801...",className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:s.draft?.isRevisit||x?"rgba(100, 100, 100, 0.2)":"var(--color-background)",border:`1px solid ${s.draft?.isRevisit||x?"var(--color-gold)":"var(--color-border)"}`,color:"var(--color-text-white)",cursor:s.draft?.isRevisit||x?"not-allowed":"text",opacity:x?.6:1}}),s.draft?.isRevisit&&!x&&t.jsx("p",{className:"text-xs mt-1",style:{color:"var(--color-gold)"},children:"Auto-generated from previous sheet"})]})]})]}),t.jsxs("div",{className:"flex gap-4 mt-8",children:[b>1&&t.jsx("button",{onClick:()=>I(b-1),className:"px-6 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),!x&&b<3?t.jsx("button",{onClick:()=>I(b+1),disabled:b===2&&!k,className:"flex-1 py-3 rounded-lg",style:{backgroundColor:b===2&&!k?"var(--color-border)":"var(--color-gold)",color:"var(--color-background)",cursor:b===2&&!k?"not-allowed":"pointer"},children:"Next"}):x&&b<3?t.jsx("button",{onClick:()=>I(b+1),className:"flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Next"}):x?null:t.jsx("button",{onClick:xe,disabled:!W||W.trim()===""||U,className:"flex-1 py-3 rounded-lg flex items-center justify-center gap-2",style:{backgroundColor:!W||W.trim()===""||U?"var(--color-border)":"var(--color-success)",color:"var(--color-background)",cursor:!W||W.trim()===""||U?"not-allowed":"pointer"},children:U?t.jsxs(t.Fragment,{children:[t.jsx(cn,{size:"small",color:"var(--color-background)"}),t.jsx("span",{children:"Submitting..."})]}):"Submit"})]}),x&&g&&b===3&&je()&&t.jsx("div",{className:"flex gap-4 mt-4",children:t.jsx("button",{onClick:()=>{g(s),d()},className:"flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Re-visit"})})]})}),wr&&t.jsxs("div",{style:{position:"fixed",inset:0,zIndex:9999,backgroundColor:"rgba(0,0,0,0.9)",display:"flex",alignItems:"center",justifyContent:"center",padding:"16px"},onClick:()=>Ve(null),children:[t.jsx("img",{src:wr,alt:"Enlarged material",style:{maxWidth:"90vw",maxHeight:"90vh",display:"block",borderRadius:"8px"},onClick:w=>w.stopPropagation()}),t.jsx("button",{onClick:()=>Ve(null),style:{position:"absolute",top:"16px",right:"16px",width:"40px",height:"40px",borderRadius:"50%",backgroundColor:"rgba(255,255,255,0.2)",color:"white",fontSize:"22px",border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"},children:"×"})]})]})}function em({username:s,onLogout:d,checkIns:i,onMarkAsHelped:u,onSaveDraft:g,onRevisit:p,onUpdateCurrentlyHelpedBy:x}){const[N,b]=f.useState("queue"),[I,L]=f.useState(null),[C,F]=f.useState(1),[$,q]=f.useState(""),[k,P]=f.useState(""),[S,M]=f.useState(""),[B,X]=f.useState(""),[W,R]=f.useState(""),[E,K]=f.useState("all"),_=10,A=i.filter(h=>h.status==="waiting"),ee=i.filter(h=>h.status==="helped"),ne=ee.filter(h=>{if($&&h.draft?.selectedFabricator&&!h.draft.selectedFabricator.companyName.toLowerCase().includes($.toLowerCase())||k&&h.helpedTime&&h.helpedTime.toISOString().split("T")[0]!==k||S&&h.draft?.selectionSheetNumber&&!h.draft.selectionSheetNumber.toLowerCase().includes(S.toLowerCase())||B&&!`${h.firstName} ${h.lastName}`.toLowerCase().includes(B.toLowerCase())||W&&!h.phones.some(oe=>oe.toLowerCase().includes(W.toLowerCase())))return!1;if(E!=="all"){const j=h.draft?.isHold||!1;if(E==="yes"&&!j||E==="no"&&j)return!1}return!0}),pe=[...ne].sort((h,j)=>!h.helpedTime||!j.helpedTime?0:j.helpedTime.getTime()-h.helpedTime.getTime()),Ce=pe.slice((C-1)*_,C*_),Ee=Math.ceil(pe.length/_),Me=h=>{const oe=new Date().getTime()-h.getTime(),le=Math.floor(oe/6e4);if(le<1)return"Just now";if(le<60)return`${le} min`;const U=Math.floor(le/60),Y=le%60;return`${U}h ${Y}m`},Pe=h=>h.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),J=h=>h.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})+" "+h.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),ce=(h,j)=>{g(h,j),j.step===3&&u(h)},te=h=>{x(h.id,s),L(h)};return t.jsxs("div",{className:"min-h-screen",style:{backgroundColor:"var(--color-background)"},children:[t.jsx("div",{className:"border-b",style:{backgroundColor:"var(--color-card)",borderColor:"var(--color-border)"},children:t.jsxs("div",{className:"max-w-7xl mx-auto px-6 py-4",children:[t.jsxs("div",{className:"flex justify-between items-center",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("img",{src:Jt,alt:"Reliance Surfaces",className:"w-12 h-12 object-contain"}),t.jsx("h2",{style:{color:"var(--color-gold)"},children:"Reliance Surfaces"})]}),t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsx("span",{style:{color:"var(--color-text-white)"},children:s}),t.jsxs("button",{className:"relative p-2 rounded-lg hover:bg-opacity-50",style:{backgroundColor:"var(--color-background)"},children:[t.jsx($p,{size:20,style:{color:"var(--color-text-gray)"}}),A.length>0&&t.jsx("span",{className:"absolute -top-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center text-xs",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:A.length})]}),t.jsxs("button",{onClick:d,className:"flex items-center gap-2 px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx(un,{size:18}),"Logout"]})]})]}),t.jsxs("div",{className:"flex gap-6 mt-6",children:[t.jsxs("button",{onClick:()=>b("queue"),className:"pb-3 px-2",style:{color:N==="queue"?"var(--color-gold)":"var(--color-text-gray)",borderBottom:N==="queue"?"2px solid var(--color-gold)":"2px solid transparent"},children:["Queue ",A.length>0&&`(${A.length})`]}),t.jsx("button",{onClick:()=>b("history"),className:"pb-3 px-2",style:{color:N==="history"?"var(--color-gold)":"var(--color-text-gray)",borderBottom:N==="history"?"2px solid var(--color-gold)":"2px solid transparent"},children:"History"})]})]})}),t.jsxs("div",{className:"max-w-7xl mx-auto px-6 py-8",children:[N==="queue"&&t.jsx("div",{children:t.jsx("div",{className:"space-y-3",children:A.length===0?t.jsx("div",{className:"text-center py-12",style:{color:"var(--color-text-gray)"},children:"No customers in queue"}):A.map(h=>t.jsxs("div",{className:"flex items-center gap-4 p-3 rounded-lg transition-all hover:bg-opacity-80",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("div",{className:"flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:h.firstName.charAt(0).toUpperCase()}),t.jsxs("div",{className:"flex-1 min-w-0",children:[t.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[t.jsx("span",{className:"font-medium truncate",style:{color:"var(--color-text-white)"},children:[h.firstName,h.lastName].filter(Boolean).join(" ")}),h.currentlyHelpedBy?t.jsxs("span",{className:"px-2 py-0.5 rounded text-xs font-medium flex-shrink-0",style:{backgroundColor:"rgba(251, 191, 36, 0.2)",color:"#fbbf24"},children:["In Progress • ",h.currentlyHelpedBy]}):t.jsx("span",{className:"px-2 py-0.5 rounded text-xs font-medium flex-shrink-0",style:{backgroundColor:"rgba(34, 197, 94, 0.2)",color:"#22c55e"},children:"New"}),h.partySize&&(h.partySize.adults>1||h.partySize.minors>0)&&t.jsxs("span",{className:"px-2 py-0.5 rounded text-xs flex-shrink-0",style:{backgroundColor:"rgba(212, 167, 54, 0.2)",color:"var(--color-gold)"},children:[h.partySize.adults," ",h.partySize.adults===1?"Adult":"Adults",h.partySize.minors>0&&`, ${h.partySize.minors} ${h.partySize.minors===1?"Minor":"Minors"}`]})]}),t.jsxs("div",{className:"flex items-center gap-4 text-xs",style:{color:"var(--color-text-gray)"},children:[t.jsxs("span",{children:["Checked in at ",Pe(h.checkInTime)]}),t.jsx("span",{children:"•"}),t.jsxs("span",{style:{color:"var(--color-gold)"},children:["Waiting ",Me(h.checkInTime)]})]})]}),t.jsx("button",{onClick:()=>te(h),className:"flex-shrink-0 px-6 py-2 rounded-lg font-medium transition-all hover:opacity-90",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"View"})]},h.id))})}),N==="history"&&t.jsxs("div",{children:[t.jsxs("div",{className:"mb-6 p-6 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("h3",{style:{color:"var(--color-gold)",marginBottom:"16px"},children:"Filter History"}),t.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Customer Name"}),t.jsx("input",{type:"text",value:B,onChange:h=>{X(h.target.value),F(1)},placeholder:"Search by name...",className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Phone Number"}),t.jsx("input",{type:"text",value:W,onChange:h=>{R(h.target.value),F(1)},placeholder:"Search by phone...",className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Fabricator"}),t.jsx("input",{type:"text",value:$,onChange:h=>{q(h.target.value),F(1)},placeholder:"Search by fabricator...",className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Selection Sheet #"}),t.jsx("input",{type:"text",value:S,onChange:h=>{M(h.target.value),F(1)},placeholder:"Search by sheet #...",className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Date"}),t.jsx("input",{type:"date",value:k,onChange:h=>{P(h.target.value),F(1)},className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Hold Status"}),t.jsxs("select",{value:E,onChange:h=>{K(h.target.value),F(1)},className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px"},children:[t.jsx("option",{value:"all",children:"All"}),t.jsx("option",{value:"yes",children:"Hold"}),t.jsx("option",{value:"no",children:"Not Hold"})]})]})]}),(B||W||$||S||k||E!=="all")&&t.jsx("button",{onClick:()=>{X(""),R(""),q(""),M(""),P(""),K("all"),F(1)},className:"mt-4 px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Clear Filters"})]}),pe.length===0?t.jsxs("div",{className:"text-center py-16",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px"},children:[t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"18px"},children:ne.length===0&&ee.length>0?"No matching results":"No history yet"}),t.jsx("p",{style:{color:"var(--color-text-gray)",marginTop:"8px"},children:ne.length===0&&ee.length>0?"Try adjusting your filters":"Helped customers will appear here"})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"rounded-lg overflow-hidden",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:t.jsx("div",{className:"overflow-x-auto",children:t.jsxs("table",{className:"w-full",style:{borderCollapse:"collapse"},children:[t.jsx("thead",{children:t.jsxs("tr",{style:{backgroundColor:"var(--color-background)",borderBottom:"1px solid var(--color-border)"},children:[t.jsx("th",{className:"px-4 py-3 text-left",style:{color:"var(--color-gold)",fontSize:"14px",fontWeight:"600"},children:"Sheet #"}),t.jsx("th",{className:"px-4 py-3 text-left",style:{color:"var(--color-gold)",fontSize:"14px",fontWeight:"600"},children:"Customer Name"}),t.jsx("th",{className:"px-4 py-3 text-left",style:{color:"var(--color-gold)",fontSize:"14px",fontWeight:"600"},children:"Phone Number"}),t.jsx("th",{className:"px-4 py-3 text-left",style:{color:"var(--color-gold)",fontSize:"14px",fontWeight:"600"},children:"Fabricator"}),t.jsx("th",{className:"px-4 py-3 text-left",style:{color:"var(--color-gold)",fontSize:"14px",fontWeight:"600"},children:"Check-in"}),t.jsx("th",{className:"px-4 py-3 text-left",style:{color:"var(--color-gold)",fontSize:"14px",fontWeight:"600"},children:"Helped At"}),t.jsx("th",{className:"px-4 py-3 text-left",style:{color:"var(--color-gold)",fontSize:"14px",fontWeight:"600"},children:"Hold"}),t.jsx("th",{className:"px-4 py-3 text-left",style:{color:"var(--color-gold)",fontSize:"14px",fontWeight:"600"}})]})}),t.jsx("tbody",{children:Ce.map((h,j)=>t.jsxs("tr",{style:{borderBottom:j<Ce.length-1?"1px solid var(--color-border)":"none",backgroundColor:j%2===0?"transparent":"rgba(0, 0, 0, 0.2)"},children:[t.jsx("td",{className:"px-4 py-4",style:{color:"var(--color-text-white)",fontSize:"14px"},children:h.draft?.selectionSheetNumber||"-"}),t.jsx("td",{className:"px-4 py-4",style:{color:"var(--color-text-white)",fontSize:"14px"},children:[h.firstName,h.lastName].filter(Boolean).join(" ")}),t.jsx("td",{className:"px-4 py-4",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:h.phones[0]||"-"}),t.jsx("td",{className:"px-4 py-4",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:h.draft?.selectedFabricator?.companyName||"-"}),t.jsx("td",{className:"px-4 py-4",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:J(h.checkInTime)}),t.jsx("td",{className:"px-4 py-4",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:h.helpedTime?J(h.helpedTime):"-"}),t.jsx("td",{className:"px-4 py-4",style:{color:h.draft?.isHold?"var(--color-gold)":"var(--color-text-gray)",fontSize:"14px",fontWeight:h.draft?.isHold?"600":"normal"},children:h.draft?.isHold?"Yes":"No"}),t.jsx("td",{className:"px-4 py-4",children:t.jsx("button",{onClick:()=>L(h),className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",fontSize:"14px"},children:"View"})})]},h.id))})]})})}),Ee>1&&t.jsxs("div",{className:"flex justify-center items-center gap-4 mt-8",children:[t.jsx("button",{onClick:()=>F(Math.max(1,C-1)),disabled:C===1,className:"px-4 py-2 rounded-lg",style:{backgroundColor:C===1?"var(--color-background)":"var(--color-card)",border:"1px solid var(--color-border)",color:C===1?"var(--color-text-gray)":"var(--color-text-white)",cursor:C===1?"not-allowed":"pointer"},children:"Previous"}),t.jsxs("span",{style:{color:"var(--color-text-white)"},children:["Page ",C," of ",Ee]}),t.jsx("button",{onClick:()=>F(Math.min(Ee,C+1)),disabled:C===Ee,className:"px-4 py-2 rounded-lg",style:{backgroundColor:C===Ee?"var(--color-background)":"var(--color-card)",border:"1px solid var(--color-border)",color:C===Ee?"var(--color-text-gray)":"var(--color-text-white)",cursor:C===Ee?"not-allowed":"pointer"},children:"Next"})]})]})]})]}),I&&t.jsx(Zh,{customer:I,onClose:()=>L(null),onSubmit:ce,onMarkAsHelped:u,onRevisit:p,staffUsername:s,isViewOnly:I.status==="helped",allCheckIns:i})]})}function zd({customer:s,onClose:d,onComplete:i}){const[u,g]=f.useState([]),[p,x]=f.useState(!1),N=s.priced||!1;f.useEffect(()=>{if(s.draft?.materials){const L=s.draft.materials.map(C=>{const F=parseFloat(C.size?.l)||0,$=parseFloat(C.size?.h)||0,q=parseFloat(C.price||"0")||0,k=C.priceType||"per SFT";return{material:C.soldAs||C.name,quantity:C.quantity,finish:C.finish||"Polished",length:F,height:$,price:q,priceType:k}});g(L)}},[s]);const b=(L,C,F)=>{if(N)return;const $=[...u];$[L]={...$[L],[C]:F},g($)},I=async()=>{if(!u.every(C=>C.price>0)&&!N){alert("Please enter prices for all materials");return}x(!0),setTimeout(()=>{console.log("Sending quote to fabricator:",s.draft?.selectedFabricator),console.log("Quote details:",{customer:[s.firstName,s.lastName].filter(Boolean).join(" "),selectionSheetNumber:s.draft?.selectionSheetNumber,materials:u.map(C=>({quantity:C.quantity,material:C.material,finish:C.finish,length:C.length,height:C.height,price:C.price,priceType:C.priceType}))}),alert(`Quote ${N?"resent":"sent"} successfully to ${s.draft?.selectedFabricator?.companyName||"fabricator"}!`),x(!1),N||i(s.id),d()},1500)};return t.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4",style:{backgroundColor:"rgba(0, 0, 0, 0.8)"},children:t.jsxs("div",{className:"w-full max-w-5xl max-h-[90vh] overflow-y-auto",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px"},children:[t.jsxs("div",{className:"sticky top-0 z-10 flex items-center justify-between p-6 border-b",style:{backgroundColor:"var(--color-card)",borderColor:"var(--color-border)"},children:[t.jsxs("div",{children:[t.jsx("h2",{className:"text-2xl mb-1",style:{color:"var(--color-gold)"},children:"Quote"}),t.jsxs("p",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:[[s.firstName,s.lastName].filter(Boolean).join(" ")," • Sheet #",s.draft?.selectionSheetNumber]})]}),t.jsx("button",{onClick:d,className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:"var(--color-background)",color:"var(--color-text-gray)"},children:t.jsx(ct,{size:24})})]}),t.jsxs("div",{className:"p-6 space-y-6",children:[t.jsxs("div",{className:"grid grid-cols-2 gap-4 p-4 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)"},children:[t.jsxs("div",{children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Customer"}),t.jsx("p",{style:{color:"var(--color-text-white)"},children:[s.firstName,s.lastName].filter(Boolean).join(" ")})]}),t.jsxs("div",{children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Fabricator"}),t.jsx("p",{style:{color:"var(--color-text-white)"},children:s.draft?.selectedFabricator?.companyName||"Not assigned"})]})]}),t.jsxs("div",{children:[t.jsx("h3",{className:"text-lg mb-3",style:{color:"var(--color-text-white)"},children:"Materials & Pricing"}),t.jsx("div",{className:"overflow-x-auto",children:t.jsxs("table",{className:"w-full",style:{borderCollapse:"collapse"},children:[t.jsx("thead",{children:t.jsxs("tr",{style:{borderBottom:"2px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:[t.jsx("th",{className:"text-center p-3 text-sm font-semibold",style:{color:"var(--color-gold)",width:"80px"},children:"Quantity"}),t.jsx("th",{className:"text-left p-3 text-sm font-semibold",style:{color:"var(--color-gold)"},children:"Material Name"}),t.jsx("th",{className:"text-center p-3 text-sm font-semibold",style:{color:"var(--color-gold)",width:"120px"},children:"Finish"}),t.jsx("th",{className:"text-center p-3 text-sm font-semibold",style:{color:"var(--color-gold)",width:"110px"},children:"Length (in)"}),t.jsx("th",{className:"text-center p-3 text-sm font-semibold",style:{color:"var(--color-gold)",width:"110px"},children:"Height (in)"}),t.jsx("th",{className:"text-right p-3 text-sm font-semibold",style:{color:"var(--color-gold)",width:"140px"},children:"Price"}),t.jsx("th",{className:"text-center p-3 text-sm font-semibold",style:{color:"var(--color-gold)",width:"120px"},children:"Type"})]})}),t.jsx("tbody",{children:u.map((L,C)=>t.jsxs("tr",{style:{borderBottom:"1px solid var(--color-border)"},children:[t.jsx("td",{className:"p-3 text-center",children:t.jsx("input",{type:"number",value:L.quantity,onChange:F=>b(C,"quantity",parseFloat(F.target.value)||0),disabled:N,className:"w-full px-2 py-2 rounded text-center",style:{backgroundColor:N?"rgba(100, 100, 100, 0.2)":"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:N?"not-allowed":"text"},min:"0"})}),t.jsx("td",{className:"p-3",style:{color:"var(--color-text-white)"},children:L.material}),t.jsx("td",{className:"p-3 text-center",style:{color:"var(--color-text-white)"},children:L.finish}),t.jsx("td",{className:"p-3 text-center",children:t.jsx("input",{type:"number",value:L.length,onChange:F=>b(C,"length",parseFloat(F.target.value)||0),disabled:N,className:"w-full px-2 py-2 rounded text-center",style:{backgroundColor:N?"rgba(100, 100, 100, 0.2)":"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:N?"not-allowed":"text"},min:"0",step:"0.1"})}),t.jsx("td",{className:"p-3 text-center",children:t.jsx("input",{type:"number",value:L.height,onChange:F=>b(C,"height",parseFloat(F.target.value)||0),disabled:N,className:"w-full px-2 py-2 rounded text-center",style:{backgroundColor:N?"rgba(100, 100, 100, 0.2)":"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:N?"not-allowed":"text"},min:"0",step:"0.1"})}),t.jsx("td",{className:"p-3 text-right",children:t.jsxs("div",{className:"flex items-center justify-end",children:[t.jsx("span",{style:{color:"var(--color-gold)",marginRight:"4px",fontSize:"16px",fontWeight:"600"},children:"$"}),t.jsx("input",{type:"number",value:L.price,onChange:F=>b(C,"price",parseFloat(F.target.value)||0),disabled:N,className:"w-full px-2 py-2 rounded text-right",style:{backgroundColor:N?"rgba(100, 100, 100, 0.2)":"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:N?"not-allowed":"text"},placeholder:"0.00",min:"0",step:"0.01"})]})}),t.jsx("td",{className:"p-3 text-center",children:t.jsxs("select",{value:L.priceType,onChange:F=>b(C,"priceType",F.target.value),disabled:N,className:"w-full px-2 py-2 rounded",style:{backgroundColor:N?"rgba(100, 100, 100, 0.2)":"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:N?"not-allowed":"pointer"},children:[t.jsx("option",{value:"per SFT",children:"per SFT"}),t.jsx("option",{value:"per Slab",children:"per Slab"})]})})]},C))})]})})]}),N&&t.jsx("div",{className:"p-4 rounded-lg",style:{backgroundColor:"rgba(34, 197, 94, 0.1)",border:"1px solid #22c55e"},children:t.jsx("p",{className:"text-center",style:{color:"#22c55e"},children:"✓ This quote has been priced and sent. You can resend the email if needed."})}),t.jsxs("div",{className:"flex gap-3 pt-4",children:[t.jsx("button",{onClick:d,className:"flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:N?"Close":"Cancel"}),t.jsxs("button",{onClick:I,disabled:p,className:"flex-1 py-3 rounded-lg flex items-center justify-center gap-2",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)",opacity:p?.6:1},children:[t.jsx(ah,{size:20}),p?"Sending...":N?"Resend Quote":"Send Quote to Fabricator"]})]})]})]})})}function rm({username:s,onLogout:d,checkIns:i,fabricators:u,onComplete:g,onResetHoldDate:p}){const[x,N]=f.useState(null),[b,I]=f.useState(""),[L,C]=f.useState(""),[F,$]=f.useState("all"),[q,k]=f.useState("all"),[P,S]=f.useState("all"),[M,B]=f.useState(!1),[X,W]=f.useState({}),[R,E]=f.useState("main"),[K,_]=f.useState({}),[A,ee]=f.useState({}),[ne,pe]=f.useState({}),[Ce,Ee]=f.useState(new Date().getFullYear()),[Me,Pe]=f.useState(new Date().getMonth()),[J,ce]=f.useState(new Date().getFullYear()),[te,h]=f.useState(new Date().getMonth()),[j,oe]=f.useState(new Date().getFullYear()),[le,U]=f.useState(new Date().getMonth()),[Y,de]=f.useState(1),be=10,ye=[2025,2026,2027,2028],Oe=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],cr=f.useMemo(()=>i.filter(O=>O.status==="helped"&&O.draft?.materials&&O.draft.materials.length>0),[i]),Fr=O=>{const ge=new Date;return new Date(O).toDateString()===ge.toDateString()},wr=O=>{const ge=new Date,Re=new Date(O);return(ge.getTime()-Re.getTime())/(1e3*60*60*24)>5},{mainDashboardCheckIns:Ve,holdsNotConvertedCheckIns:br,ignoredCheckIns:jr}=f.useMemo(()=>{const O=[],ge=[],Re=[];return cr.forEach(_e=>{const H=K[_e.id]||!1,me=_e.draft?.isHold||!1,Ae=!X[_e.id],Be=wr(_e.checkInTime);H?Re.push(_e):me&&Ae&&Be?ge.push(_e):O.push(_e)}),{mainDashboardCheckIns:O,holdsNotConvertedCheckIns:ge,ignoredCheckIns:Re}},[cr,X,K]),Lr=f.useMemo(()=>R==="holds-not-converted"?br:R==="ignored"?jr:Ve,[R,Ve,br,jr]),We=f.useMemo(()=>[...Lr.filter(ge=>{const Re=`${ge.firstName} ${ge.lastName}`.toLowerCase().includes(b.toLowerCase())||ge.phones?.some(Be=>Be.includes(b))||ge.draft?.selectionSheetNumber?.includes(b),_e=!L||ge.draft?.selectedFabricator?.id===L,H=F==="all"||F==="hold"&&ge.draft?.isHold||F==="no-hold"&&!ge.draft?.isHold,me=q==="all"||q==="priced"&&ge.priced||q==="not-priced"&&!ge.priced,Ae=P==="all"||P==="yes"&&X[ge.id]||P==="no"&&!X[ge.id];return Re&&_e&&H&&me&&Ae})].sort((ge,Re)=>new Date(Re.checkInTime).getTime()-new Date(ge.checkInTime).getTime()),[Lr,b,L,F,q,P,X]),or=Math.ceil(We.length/be),De=(Y-1)*be,Z=De+be,xe=We.slice(De,Z);Yr.useEffect(()=>{de(1)},[b,L,F,q,P,R]);const je=O=>{N(O)},ke=O=>{_({...K,[O]:!0})},w=O=>{p&&p(O),pe({...ne,[O]:!0})},se=O=>{ee({...A,[O]:!A[O]})},Qe=O=>new Date(O).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"});f.useMemo(()=>{const O=new Set;return cr.forEach(Re=>{const _e=new Date(Re.checkInTime),H=`${_e.getFullYear()}-${String(_e.getMonth()+1).padStart(2,"0")}`;if(O.add(H),Re.pricedTime){const me=new Date(Re.pricedTime),Ae=`${me.getFullYear()}-${String(me.getMonth()+1).padStart(2,"0")}`;O.add(Ae)}}),Array.from(O).sort().reverse()},[cr]),f.useMemo(()=>{const O=new Date;return`${O.getFullYear()}-${String(O.getMonth()+1).padStart(2,"0")}`},[]),Yr.useEffect(()=>{Me||Pe(new Date().getMonth()),te||h(new Date().getMonth()),le||U(new Date().getMonth())},[]);const Te=(O,ge,Re)=>{const _e=new Date(O);return _e.getMonth()===ge&&_e.getFullYear()===Re},Ue=f.useMemo(()=>({pendingPricing:Ve.filter(O=>!O.priced).length,pricedToday:Ve.filter(O=>O.priced&&O.pricedTime&&Fr(O.pricedTime)).length,onHold:Ve.filter(O=>O.draft?.isHold).length,onHoldForMonth:Ve.filter(O=>O.draft?.isHold&&Te(O.checkInTime,te,J)).length,pricedForMonth:Ve.filter(O=>O.priced&&O.pricedTime&&Te(O.pricedTime,Me,Ce)).length,convertedForMonth:Ve.filter(O=>X[O.id]&&Te(O.checkInTime,le,j)).length}),[Ve,X,Me,Ce,te,J,le,j]);return t.jsxs("div",{className:"min-h-screen",style:{backgroundColor:"var(--color-background)"},children:[t.jsx("div",{className:"border-b",style:{backgroundColor:"var(--color-card)",borderColor:"var(--color-border)"},children:t.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4",children:t.jsxs("div",{className:"flex items-center justify-between",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("img",{src:Jt,alt:"Reliance Surfaces",className:"w-10 h-10 object-contain"}),t.jsxs("div",{children:[t.jsx("h1",{className:"text-xl",style:{color:"var(--color-gold)"},children:"Pricing Dashboard"}),t.jsxs("p",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:["Welcome, ",s]})]})]}),t.jsxs("button",{onClick:d,className:"flex items-center gap-2 px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx(un,{size:18}),"Logout"]})]})})}),t.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6",children:[t.jsxs("div",{className:"flex gap-2 mb-6",children:[t.jsx("button",{onClick:()=>E("main"),className:"px-6 py-3 rounded-lg transition-colors",style:{backgroundColor:R==="main"?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:R==="main"?"var(--color-background)":"var(--color-text-white)",fontWeight:R==="main"?"600":"normal"},children:"Main Dashboard"}),t.jsxs("button",{onClick:()=>E("holds-not-converted"),className:"px-6 py-3 rounded-lg transition-colors",style:{backgroundColor:R==="holds-not-converted"?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:R==="holds-not-converted"?"var(--color-background)":"var(--color-text-white)",fontWeight:R==="holds-not-converted"?"600":"normal"},children:["Holds Not Converted (",br.length,")"]}),t.jsxs("button",{onClick:()=>E("ignored"),className:"px-6 py-3 rounded-lg transition-colors",style:{backgroundColor:R==="ignored"?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:R==="ignored"?"var(--color-background)":"var(--color-text-white)",fontWeight:R==="ignored"?"600":"normal"},children:["Ignored (",jr.length,")"]})]}),t.jsxs("div",{className:"mb-6 space-y-4",children:[t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3",children:[t.jsxs("div",{className:"flex-1 relative",children:[t.jsx(Cd,{className:"absolute left-3 top-1/2 -translate-y-1/2",size:20,style:{color:"var(--color-text-gray)"}}),t.jsx("input",{type:"text",value:b,onChange:O=>I(O.target.value),placeholder:"Search by name, phone, or sheet number...",className:"w-full pl-10 pr-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("button",{onClick:()=>B(!M),className:"flex items-center justify-center gap-2 px-6 py-3 rounded-lg",style:{backgroundColor:M?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:M?"var(--color-background)":"var(--color-text-white)"},children:[t.jsx(Nd,{size:20}),"Filters"]})]}),M&&t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Fabricator"}),t.jsxs("select",{value:L,onChange:O=>C(O.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"",children:"All Fabricators"}),u.map(O=>t.jsx("option",{value:O.id,children:O.companyName},O.id))]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Hold Status"}),t.jsxs("select",{value:F,onChange:O=>$(O.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"all",children:"All"}),t.jsx("option",{value:"hold",children:"On Hold"}),t.jsx("option",{value:"no-hold",children:"Not On Hold"})]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Priced Status"}),t.jsxs("select",{value:q,onChange:O=>k(O.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"all",children:"All"}),t.jsx("option",{value:"priced",children:"Priced"}),t.jsx("option",{value:"not-priced",children:"Not Priced"})]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Converted Status"}),t.jsxs("select",{value:P,onChange:O=>S(O.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"all",children:"All"}),t.jsx("option",{value:"yes",children:"Converted"}),t.jsx("option",{value:"no",children:"Not Converted"})]})]})]})]}),R==="main"&&t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6",children:[t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Pending Pricing"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:Ue.pendingPricing})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Priced Today"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:Ue.pricedToday})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"On Hold"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:Ue.onHold})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Priced"}),t.jsx("p",{className:"text-2xl mb-2",style:{color:"var(--color-gold)"},children:Ue.pricedForMonth}),t.jsxs("div",{className:"flex gap-2",children:[t.jsx("select",{value:Me,onChange:O=>Pe(parseInt(O.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:Oe.map((O,ge)=>t.jsx("option",{value:ge,children:O},ge))}),t.jsx("select",{value:Ce,onChange:O=>Ee(parseInt(O.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:ye.map(O=>t.jsx("option",{value:O,children:O},O))})]})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"On Hold"}),t.jsx("p",{className:"text-2xl mb-2",style:{color:"var(--color-gold)"},children:Ue.onHoldForMonth}),t.jsxs("div",{className:"flex gap-2",children:[t.jsx("select",{value:te,onChange:O=>h(parseInt(O.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:Oe.map((O,ge)=>t.jsx("option",{value:ge,children:O},ge))}),t.jsx("select",{value:J,onChange:O=>ce(parseInt(O.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:ye.map(O=>t.jsx("option",{value:O,children:O},O))})]})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Converted"}),t.jsx("p",{className:"text-2xl mb-2",style:{color:"var(--color-gold)"},children:Ue.convertedForMonth}),t.jsxs("div",{className:"flex gap-2",children:[t.jsx("select",{value:le,onChange:O=>U(parseInt(O.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:Oe.map((O,ge)=>t.jsx("option",{value:ge,children:O},ge))}),t.jsx("select",{value:j,onChange:O=>oe(parseInt(O.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:ye.map(O=>t.jsx("option",{value:O,children:O},O))})]})]})]}),R==="holds-not-converted"&&t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6",children:[t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"On Hold"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:br.filter(O=>O.draft?.isHold).length})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Not Converted"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:br.filter(O=>!X[O.id]).length})]})]}),R==="ignored"&&t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6",children:[t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Total Ignored"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:jr.length})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"On Hold"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:jr.filter(O=>O.draft?.isHold).length})]})]}),t.jsxs("div",{className:"rounded-lg overflow-hidden",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("div",{className:"overflow-x-auto",children:t.jsxs("table",{className:"w-full",children:[t.jsx("thead",{style:{backgroundColor:"var(--color-background)"},children:t.jsxs("tr",{children:[t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Customer"}),t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Sheet #"}),t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Fabricator"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Materials"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Status"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Converted"}),R==="ignored"&&t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Lot"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Date"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Actions"})]})}),t.jsx("tbody",{children:xe.length===0?t.jsx("tr",{children:t.jsx("td",{colSpan:R==="ignored"?9:8,className:"text-center p-8",style:{color:"var(--color-text-gray)"},children:"No customers found"})}):xe.map(O=>{const ge=X[O.id]||!1,Re=A[O.id]||!1,_e=ne[O.id]||!1;let H="transparent";return R==="ignored"&&Re?H="rgba(34, 197, 94, 0.2)":_e?H="rgba(239, 68, 68, 0.2)":ge?H="rgba(212, 167, 54, 0.15)":O.priced&&(H="rgba(34, 197, 94, 0.1)"),t.jsxs("tr",{style:{borderBottom:"1px solid var(--color-border)",backgroundColor:H},children:[t.jsxs("td",{className:"p-4",children:[t.jsx("div",{style:{color:"var(--color-text-white)"},children:[O.firstName,O.lastName].filter(Boolean).join(" ")}),t.jsx("div",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:O.phones?.[0]})]}),t.jsx("td",{className:"p-4",style:{color:"var(--color-gold)"},children:O.draft?.selectionSheetNumber||"-"}),t.jsx("td",{className:"p-4",style:{color:"var(--color-text-white)"},children:O.draft?.selectedFabricator?.companyName||"-"}),t.jsx("td",{className:"p-4 text-center",style:{color:"var(--color-text-white)"},children:O.draft?.materials?.length||0}),t.jsx("td",{className:"p-4",children:t.jsxs("div",{className:"flex justify-center gap-2",children:[O.priced&&t.jsx("span",{className:"px-2 py-1 rounded text-xs",style:{backgroundColor:"rgba(34, 197, 94, 0.2)",color:"#22c55e"},children:"Priced"}),O.draft?.isHold&&t.jsx("span",{className:"px-2 py-1 rounded text-xs",style:{backgroundColor:"rgba(251, 191, 36, 0.2)",color:"#fbbf24"},children:"Hold"})]})}),t.jsx("td",{className:"p-4 text-center",children:t.jsxs("select",{value:ge?"Yes":"No",onChange:me=>W({...X,[O.id]:me.target.value==="Yes"}),className:"px-3 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:ge?"1px solid var(--color-gold)":"1px solid var(--color-border)",color:ge?"var(--color-gold)":"var(--color-text-white)",cursor:"pointer",fontWeight:ge?"600":"normal",fontSize:"13px"},children:[t.jsx("option",{value:"No",children:"No"}),t.jsx("option",{value:"Yes",children:"Yes"})]})}),R==="ignored"&&t.jsx("td",{className:"p-4",style:{color:"var(--color-text-white)"},children:O.draft?.materials&&O.draft.materials.length>0?t.jsx("div",{className:"flex flex-col gap-1",children:Array.from(new Set(O.draft.materials.map(me=>me.lot).filter(Boolean))).map((me,Ae)=>t.jsx("span",{className:"text-sm",children:me},Ae))}):"-"}),t.jsx("td",{className:"p-4 text-center text-sm",style:{color:"var(--color-text-gray)"},children:Qe(O.checkInTime)}),t.jsx("td",{className:"p-4",children:t.jsxs("div",{className:"flex justify-center",children:[t.jsx("button",{onClick:()=>je(O),className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},title:"View Pricing",children:t.jsx(vs,{size:18})}),R==="holds-not-converted"&&t.jsxs(t.Fragment,{children:[t.jsx("button",{onClick:()=>w(O.id),className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:"rgba(34, 197, 94, 0.7)",color:"var(--color-text-white)"},title:"Undo - Send back to Main",children:t.jsx(jd,{size:18})}),t.jsx("button",{onClick:()=>ke(O.id),className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:"rgba(239, 68, 68, 0.8)",color:"var(--color-text-white)"},title:"Ignore",children:t.jsx(ct,{size:18})})]}),R==="ignored"&&t.jsx("button",{onClick:()=>se(O.id),className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:Re?"rgba(34, 197, 94, 0.8)":"rgba(100, 100, 100, 0.5)",color:"var(--color-text-white)"},title:Re?"Unmark as Known":"Mark as Known",children:t.jsx(yd,{size:18})})]})})]},O.id)})})]})}),or>1&&t.jsxs("div",{className:"flex items-center justify-between px-4 py-4",style:{borderTop:"1px solid var(--color-border)"},children:[t.jsxs("div",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:["Showing ",De+1," to ",Math.min(Z,We.length)," of ",We.length," customers"]}),t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("button",{onClick:()=>de(Y-1),disabled:Y===1,className:"px-4 py-2 rounded-lg transition-colors",style:{backgroundColor:Y===1?"var(--color-background)":"var(--color-card)",border:"1px solid var(--color-border)",color:Y===1?"var(--color-text-gray)":"var(--color-text-white)",cursor:Y===1?"not-allowed":"pointer"},children:"Previous"}),t.jsx("div",{className:"flex gap-1",children:Array.from({length:or},(O,ge)=>ge+1).map(O=>t.jsx("button",{onClick:()=>de(O),className:"px-3 py-2 rounded-lg transition-colors",style:{backgroundColor:Y===O?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:Y===O?"var(--color-background)":"var(--color-text-white)",fontWeight:Y===O?"600":"normal",cursor:"pointer"},children:O},O))}),t.jsx("button",{onClick:()=>de(Y+1),disabled:Y===or,className:"px-4 py-2 rounded-lg transition-colors",style:{backgroundColor:Y===or?"var(--color-background)":"var(--color-card)",border:"1px solid var(--color-border)",color:Y===or?"var(--color-text-gray)":"var(--color-text-white)",cursor:Y===or?"not-allowed":"pointer"},children:"Next"})]})]})]})]}),x&&t.jsx(zd,{customer:x,onClose:()=>N(null),onComplete:g})]})}function tm({username:s,onLogout:d,checkIns:i,fabricators:u,onComplete:g,onResetHoldDate:p,onPriceUpdate:x}){const[N,b]=f.useState(null),[I,L]=f.useState(""),[C,F]=f.useState(""),[$,q]=f.useState(""),[k,P]=f.useState("all"),[S,M]=f.useState("all"),[B,X]=f.useState("all"),[W,R]=f.useState(!1),[E,K]=f.useState({}),[_,A]=f.useState("main"),[ee,ne]=f.useState({}),[pe,Ce]=f.useState({}),[Ee,Me]=f.useState({}),[Pe,J]=f.useState(new Date().getFullYear()),[ce,te]=f.useState(new Date().getMonth()),[h,j]=f.useState(new Date().getFullYear()),[oe,le]=f.useState(new Date().getMonth()),[U,Y]=f.useState(new Date().getFullYear()),[de,be]=f.useState(new Date().getMonth()),[ye,Oe]=f.useState(1),cr=10,Fr=[2025,2026,2027,2028],wr=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Ve=f.useMemo(()=>i.filter(H=>H.status==="helped"&&H.draft?.materials&&H.draft.materials.length>0),[i]),br=f.useMemo(()=>{const H=new Set;return Ve.forEach(me=>{me.draft?.salesPerson&&H.add(me.draft.salesPerson)}),Array.from(H).sort()},[Ve]),jr=H=>{const me=new Date;return new Date(H).toDateString()===me.toDateString()},Lr=H=>{const me=new Date,Ae=new Date(H);return(me.getTime()-Ae.getTime())/(1e3*60*60*24)>5},{mainDashboardCheckIns:We,holdsNotConvertedCheckIns:or,ignoredCheckIns:De}=f.useMemo(()=>{const H=[],me=[],Ae=[];return Ve.forEach(Be=>{const lr=ee[Be.id]||!1,hr=Be.draft?.isHold||!1,Or=!E[Be.id],Cr=Lr(Be.checkInTime);lr?Ae.push(Be):hr&&Or&&Cr?me.push(Be):H.push(Be)}),{mainDashboardCheckIns:H,holdsNotConvertedCheckIns:me,ignoredCheckIns:Ae}},[Ve,E,ee]),Z=f.useMemo(()=>_==="holds-not-converted"?or:_==="ignored"?De:We,[_,We,or,De]),xe=f.useMemo(()=>[...Z.filter(me=>{const Ae=`${me.firstName} ${me.lastName}`.toLowerCase().includes(I.toLowerCase())||me.phones?.some(Vr=>Vr.includes(I))||me.draft?.selectionSheetNumber?.includes(I),Be=!C||me.draft?.selectedFabricator?.id===C,lr=!$||me.draft?.salesPerson===$,hr=k==="all"||k==="hold"&&me.draft?.isHold||k==="no-hold"&&!me.draft?.isHold,Or=S==="all"||S==="priced"&&me.priced||S==="not-priced"&&!me.priced,Cr=B==="all"||B==="yes"&&E[me.id]||B==="no"&&!E[me.id];return Ae&&Be&&lr&&hr&&Or&&Cr})].sort((me,Ae)=>new Date(Ae.checkInTime).getTime()-new Date(me.checkInTime).getTime()),[Z,I,C,$,k,S,B,E]),je=Math.ceil(xe.length/cr),ke=(ye-1)*cr,w=ke+cr,se=xe.slice(ke,w);Yr.useEffect(()=>{Oe(1)},[I,C,$,k,S,B,_]);const Qe=H=>{b(H)},Te=H=>{ne({...ee,[H]:!0})},Ue=H=>{p&&p(H),Me({...Ee,[H]:!0})},O=H=>{Ce({...pe,[H]:!pe[H]})},ge=H=>new Date(H).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}),Re=(H,me,Ae)=>{const Be=new Date(H);return Be.getMonth()===me&&Be.getFullYear()===Ae},_e=f.useMemo(()=>{const H=We.filter(Le=>!Le.priced).length,me=We.filter(Le=>Le.priced&&Le.pricedTime&&jr(Le.pricedTime)).length,Ae=We.filter(Le=>Le.draft?.isHold).length,Be=We.filter(Le=>Le.draft?.isHold&&Re(Le.checkInTime,oe,h)).length,lr=We.filter(Le=>Le.priced&&Le.pricedTime&&Re(Le.pricedTime,ce,Pe)).length,hr=We.filter(Le=>E[Le.id]&&Re(Le.checkInTime,de,U)).length,Or=We.filter(Le=>E[Le.id]).length,Cr=$?We.filter(Le=>Le.draft?.salesPerson===$).length:We.length,Vr=$?We.filter(Le=>Le.draft?.salesPerson===$&&E[Le.id]).length:We.filter(Le=>E[Le.id]).length,pn=Cr>0?(Vr/Cr*100).toFixed(1):"0";return{pendingPricing:H,pricedToday:me,onHold:Ae,onHoldForMonth:Be,pricedForMonth:lr,convertedForMonth:hr,totalConverted:Or,totalCustomers:Cr,convertedCustomers:Vr,conversionRate:pn}},[We,E,ce,Pe,oe,h,de,U,$]);return t.jsxs("div",{className:"min-h-screen",style:{backgroundColor:"var(--color-background)"},children:[t.jsx("div",{className:"border-b",style:{backgroundColor:"var(--color-card)",borderColor:"var(--color-border)"},children:t.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4",children:t.jsxs("div",{className:"flex items-center justify-between",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("img",{src:Jt,alt:"Reliance Surfaces",className:"w-10 h-10 object-contain"}),t.jsxs("div",{children:[t.jsx("h1",{className:"text-xl",style:{color:"var(--color-gold)"},children:"Analysis Dashboard"}),t.jsxs("p",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:["Welcome, ",s]})]})]}),t.jsxs("button",{onClick:d,className:"flex items-center gap-2 px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx(un,{size:18}),"Logout"]})]})})}),t.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6",children:[t.jsxs("div",{className:"flex gap-2 mb-6",children:[t.jsx("button",{onClick:()=>A("main"),className:"px-6 py-3 rounded-lg transition-colors",style:{backgroundColor:_==="main"?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:_==="main"?"var(--color-background)":"var(--color-text-white)",fontWeight:_==="main"?"600":"normal"},children:"Main Dashboard"}),t.jsxs("button",{onClick:()=>A("holds-not-converted"),className:"px-6 py-3 rounded-lg transition-colors",style:{backgroundColor:_==="holds-not-converted"?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:_==="holds-not-converted"?"var(--color-background)":"var(--color-text-white)",fontWeight:_==="holds-not-converted"?"600":"normal"},children:["Holds Not Converted (",or.length,")"]}),t.jsxs("button",{onClick:()=>A("ignored"),className:"px-6 py-3 rounded-lg transition-colors",style:{backgroundColor:_==="ignored"?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:_==="ignored"?"var(--color-background)":"var(--color-text-white)",fontWeight:_==="ignored"?"600":"normal"},children:["Ignored (",De.length,")"]})]}),t.jsxs("div",{className:"mb-6 space-y-4",children:[t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3",children:[t.jsxs("div",{className:"flex-1 relative",children:[t.jsx(Cd,{className:"absolute left-3 top-1/2 -translate-y-1/2",size:20,style:{color:"var(--color-text-gray)"}}),t.jsx("input",{type:"text",value:I,onChange:H=>L(H.target.value),placeholder:"Search by name, phone, or sheet number...",className:"w-full pl-10 pr-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("button",{onClick:()=>R(!W),className:"flex items-center justify-center gap-2 px-6 py-3 rounded-lg",style:{backgroundColor:W?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:W?"var(--color-background)":"var(--color-text-white)"},children:[t.jsx(Nd,{size:20}),"Filters"]})]}),W&&t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Sales Person"}),t.jsxs("select",{value:$,onChange:H=>q(H.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"",children:"All Sales People"}),br.map(H=>t.jsx("option",{value:H,children:H},H))]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Fabricator"}),t.jsxs("select",{value:C,onChange:H=>F(H.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"",children:"All Fabricators"}),u.map(H=>t.jsx("option",{value:H.id,children:H.companyName},H.id))]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Hold Status"}),t.jsxs("select",{value:k,onChange:H=>P(H.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"all",children:"All"}),t.jsx("option",{value:"hold",children:"On Hold"}),t.jsx("option",{value:"no-hold",children:"Not On Hold"})]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Priced Status"}),t.jsxs("select",{value:S,onChange:H=>M(H.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"all",children:"All"}),t.jsx("option",{value:"priced",children:"Priced"}),t.jsx("option",{value:"not-priced",children:"Not Priced"})]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Converted Status"}),t.jsxs("select",{value:B,onChange:H=>X(H.target.value),className:"w-full px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"all",children:"All"}),t.jsx("option",{value:"yes",children:"Converted"}),t.jsx("option",{value:"no",children:"Not Converted"})]})]})]})]}),_==="main"&&t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6",children:[$&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"2px solid var(--color-gold)"},children:[t.jsxs("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:["Sales Person: ",$]}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:_e.totalCustomers}),t.jsx("p",{className:"text-xs mt-1",style:{color:"var(--color-text-gray)"},children:"Total Customers"})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"2px solid var(--color-gold)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Converted"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:_e.convertedCustomers}),t.jsxs("p",{className:"text-xs mt-1",style:{color:"var(--color-text-gray)"},children:[_e.conversionRate,"% Rate"]})]})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Pending Pricing"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:_e.pendingPricing})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Priced Today"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:_e.pricedToday})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"On Hold"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:_e.onHold})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Total Converted"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:_e.totalConverted})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"On Hold"}),t.jsx("p",{className:"text-2xl mb-2",style:{color:"var(--color-gold)"},children:_e.onHoldForMonth}),t.jsxs("div",{className:"flex gap-2",children:[t.jsx("select",{value:oe,onChange:H=>le(parseInt(H.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:wr.map((H,me)=>t.jsx("option",{value:me,children:H},me))}),t.jsx("select",{value:h,onChange:H=>j(parseInt(H.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:Fr.map(H=>t.jsx("option",{value:H,children:H},H))})]})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-2",style:{color:"var(--color-text-gray)"},children:"Converted"}),t.jsx("p",{className:"text-2xl mb-2",style:{color:"var(--color-gold)"},children:_e.convertedForMonth}),t.jsxs("div",{className:"flex gap-2",children:[t.jsx("select",{value:de,onChange:H=>be(parseInt(H.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:wr.map((H,me)=>t.jsx("option",{value:me,children:H},me))}),t.jsx("select",{value:U,onChange:H=>Y(parseInt(H.target.value)),className:"flex-1 text-sm px-2 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:"pointer"},children:Fr.map(H=>t.jsx("option",{value:H,children:H},H))})]})]})]}),_==="holds-not-converted"&&t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6",children:[t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"On Hold"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:or.filter(H=>H.draft?.isHold).length})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Not Converted"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:or.filter(H=>!E[H.id]).length})]})]}),_==="ignored"&&t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6",children:[t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Total Ignored"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:De.length})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"On Hold"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:De.filter(H=>H.draft?.isHold).length})]})]}),t.jsxs("div",{className:"rounded-lg overflow-hidden",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("div",{className:"overflow-x-auto",children:t.jsxs("table",{className:"w-full",children:[t.jsx("thead",{style:{backgroundColor:"var(--color-background)"},children:t.jsxs("tr",{children:[t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Customer"}),t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Sheet #"}),t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Sales Person"}),t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Fabricator"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Materials"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Status"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Converted"}),_==="ignored"&&t.jsx("th",{className:"text-left p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Lot"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Date"}),t.jsx("th",{className:"text-center p-4 text-sm",style:{color:"var(--color-text-gray)"},children:"Actions"})]})}),t.jsx("tbody",{children:se.length===0?t.jsx("tr",{children:t.jsx("td",{colSpan:_==="ignored"?10:9,className:"text-center p-8",style:{color:"var(--color-text-gray)"},children:"No customers found"})}):se.map(H=>{const me=E[H.id]||!1,Ae=pe[H.id]||!1,Be=Ee[H.id]||!1;let lr="transparent";return _==="ignored"&&Ae?lr="rgba(34, 197, 94, 0.2)":Be?lr="rgba(239, 68, 68, 0.2)":me?lr="rgba(212, 167, 54, 0.15)":H.priced&&(lr="rgba(34, 197, 94, 0.1)"),t.jsxs("tr",{style:{borderBottom:"1px solid var(--color-border)",backgroundColor:lr},children:[t.jsxs("td",{className:"p-4",children:[t.jsx("div",{style:{color:"var(--color-text-white)"},children:[H.firstName,H.lastName].filter(Boolean).join(" ")}),t.jsx("div",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:H.phones?.[0]})]}),t.jsx("td",{className:"p-4",style:{color:"var(--color-gold)"},children:H.draft?.selectionSheetNumber||"-"}),t.jsx("td",{className:"p-4",style:{color:"var(--color-text-white)"},children:H.draft?.salesPerson||"-"}),t.jsx("td",{className:"p-4",style:{color:"var(--color-text-white)"},children:H.draft?.selectedFabricator?.companyName||"-"}),t.jsx("td",{className:"p-4 text-center",style:{color:"var(--color-text-white)"},children:H.draft?.materials?.length||0}),t.jsx("td",{className:"p-4",children:t.jsxs("div",{className:"flex justify-center gap-2",children:[H.priced&&t.jsx("span",{className:"px-2 py-1 rounded text-xs",style:{backgroundColor:"rgba(34, 197, 94, 0.2)",color:"#22c55e"},children:"Priced"}),H.draft?.isHold&&t.jsx("span",{className:"px-2 py-1 rounded text-xs",style:{backgroundColor:"rgba(251, 191, 36, 0.2)",color:"#fbbf24"},children:"Hold"})]})}),t.jsx("td",{className:"p-4 text-center",children:t.jsxs("select",{value:me?"Yes":"No",onChange:hr=>K({...E,[H.id]:hr.target.value==="Yes"}),className:"px-3 py-1.5 rounded",style:{backgroundColor:"var(--color-background)",border:me?"1px solid var(--color-gold)":"1px solid var(--color-border)",color:me?"var(--color-gold)":"var(--color-text-white)",cursor:"pointer",fontWeight:me?"600":"normal",fontSize:"13px"},children:[t.jsx("option",{value:"No",children:"No"}),t.jsx("option",{value:"Yes",children:"Yes"})]})}),_==="ignored"&&t.jsx("td",{className:"p-4",style:{color:"var(--color-text-white)"},children:H.draft?.materials&&H.draft.materials.length>0?t.jsx("div",{className:"flex flex-col gap-1",children:Array.from(new Set(H.draft.materials.map(hr=>hr.lot).filter(Boolean))).map((hr,Or)=>t.jsx("span",{className:"text-sm",children:hr},Or))}):"-"}),t.jsx("td",{className:"p-4 text-center text-sm",style:{color:"var(--color-text-gray)"},children:ge(H.checkInTime)}),t.jsx("td",{className:"p-4",children:t.jsxs("div",{className:"flex justify-center gap-1",children:[t.jsx("button",{onClick:()=>Qe(H),className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},title:"View/Edit Pricing",children:t.jsx(vs,{size:18})}),_==="holds-not-converted"&&t.jsxs(t.Fragment,{children:[t.jsx("button",{onClick:()=>Ue(H.id),className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:"rgba(34, 197, 94, 0.7)",color:"var(--color-text-white)"},title:"Undo - Send back to Main",children:t.jsx(jd,{size:18})}),t.jsx("button",{onClick:()=>Te(H.id),className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:"rgba(239, 68, 68, 0.8)",color:"var(--color-text-white)"},title:"Ignore",children:t.jsx(ct,{size:18})})]}),_==="ignored"&&t.jsx("button",{onClick:()=>O(H.id),className:"p-2 rounded-lg hover:bg-opacity-80",style:{backgroundColor:Ae?"rgba(34, 197, 94, 0.8)":"rgba(100, 100, 100, 0.5)",color:"var(--color-text-white)"},title:Ae?"Unmark as Known":"Mark as Known",children:t.jsx(yd,{size:18})})]})})]},H.id)})})]})}),je>1&&t.jsxs("div",{className:"flex items-center justify-between px-4 py-4",style:{borderTop:"1px solid var(--color-border)"},children:[t.jsxs("div",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:["Showing ",ke+1," to ",Math.min(w,xe.length)," of ",xe.length," customers"]}),t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("button",{onClick:()=>Oe(ye-1),disabled:ye===1,className:"px-4 py-2 rounded-lg transition-colors",style:{backgroundColor:ye===1?"var(--color-background)":"var(--color-card)",border:"1px solid var(--color-border)",color:ye===1?"var(--color-text-gray)":"var(--color-text-white)",cursor:ye===1?"not-allowed":"pointer"},children:"Previous"}),t.jsx("div",{className:"flex gap-1",children:Array.from({length:je},(H,me)=>me+1).map(H=>t.jsx("button",{onClick:()=>Oe(H),className:"px-3 py-2 rounded-lg transition-colors",style:{backgroundColor:ye===H?"var(--color-gold)":"var(--color-card)",border:"1px solid var(--color-border)",color:ye===H?"var(--color-background)":"var(--color-text-white)",fontWeight:ye===H?"600":"normal",cursor:"pointer"},children:H},H))}),t.jsx("button",{onClick:()=>Oe(ye+1),disabled:ye===je,className:"px-4 py-2 rounded-lg transition-colors",style:{backgroundColor:ye===je?"var(--color-background)":"var(--color-card)",border:"1px solid var(--color-border)",color:ye===je?"var(--color-text-gray)":"var(--color-text-white)",cursor:ye===je?"not-allowed":"pointer"},children:"Next"})]})]})]})]}),N&&t.jsx(zd,{customer:N,onClose:()=>b(null),onComplete:H=>{x&&x(H,s),g(H)},isAnalysisMode:!0,analysisUser:s})]})}function om({onCustomerFound:s,onBack:d,checkIns:i}){const[u,g]=f.useState(""),[p,x]=f.useState(!1),[N,b]=f.useState(""),I=async()=>{if(!u.trim()){b("Please enter a phone number or email");return}x(!0),b("");try{const C=u.trim().toLowerCase(),F=i.find($=>{const q=$.phones?.some(P=>P.replace(/\D/g,"").includes(C.replace(/\D/g,""))),k=$.emails?.some(P=>P.toLowerCase().includes(C));return q||k});F?s(F):b('No previous check-in found with this information. Please use "Check-In" for first-time visit.')}catch{b('No previous check-in found with this information. Please use "Check-In" for first-time visit.')}finally{x(!1)}},L=C=>{C.key==="Enter"&&I()};return t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-md",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"32px"},children:[t.jsx("h1",{className:"text-center mb-3 text-3xl",style:{color:"var(--color-gold)"},children:"Welcome Back!"}),t.jsx("p",{className:"text-center mb-8",style:{color:"var(--color-text-gray)"},children:"Enter your mobile number or email that you used during check-in"}),t.jsxs("div",{className:"space-y-6",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Phone or Email"}),t.jsx("input",{type:"text",value:u,onChange:C=>{g(C.target.value),b("")},onKeyPress:L,placeholder:"(602) 555-1234 or email@example.com",className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${N?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"},disabled:p}),N&&t.jsx("p",{className:"mt-2 text-sm",style:{color:"#EF4444"},children:N})]}),t.jsxs("div",{className:"space-y-3",children:[t.jsx("button",{onClick:I,disabled:p,className:"w-full py-3 rounded-lg",style:{backgroundColor:p?"var(--color-border)":"var(--color-gold)",color:"var(--color-background)",cursor:p?"not-allowed":"pointer",opacity:p?.6:1},children:p?"Searching...":"Find My Information"}),t.jsx("button",{onClick:d,disabled:p,className:"w-full py-3 rounded-lg",style:{backgroundColor:"transparent",border:"1px solid var(--color-border)",color:"var(--color-text-white)",cursor:p?"not-allowed":"pointer",opacity:p?.6:1},children:"Back to Home"})]})]})]})})}function nm({customerData:s,onNext:d,onBack:i}){const[u,g]=f.useState({firstName:s.firstName||"",lastName:s.lastName||"",street:s.street||"",suiteUnit:s.suiteUnit||"",city:s.city||"",state:s.state||"",zip:s.zip||"",country:s.country||"USA",phones:s.phones||[""],emails:s.emails||[""]}),[p,x]=f.useState({}),N=P=>P.split(" ").map(S=>S.charAt(0).toUpperCase()+S.slice(1).toLowerCase()).join(" "),b=()=>{const P={};u.firstName.trim()||(P.firstName="First name is required"),u.lastName.trim()||(P.lastName="Last name is required"),u.street.trim()||(P.street="Street address is required"),u.city.trim()||(P.city="City is required"),u.state.trim()||(P.state="State is required"),u.zip.trim()||(P.zip="ZIP code is required");const S=u.phones.filter(B=>B.trim());S.length===0?P.phones="At least one phone number is required":S.forEach((B,X)=>{B.replace(/\D/g,"").length!==10&&(P[`phone${X}`]="Phone must be 10 digits")});const M=u.emails.filter(B=>B.trim());return M.length===0?P.emails="At least one email is required":M.forEach((B,X)=>{/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(B)||(P[`email${X}`]="Invalid email format")}),x(P),Object.keys(P).length===0},I=P=>{P.preventDefault(),b()&&d(u)},L=()=>{g({...u,phones:[...u.phones,""]})},C=P=>{u.phones.length>1&&g({...u,phones:u.phones.filter((S,M)=>M!==P)})},F=(P,S)=>{const M=[...u.phones];M[P]=S,g({...u,phones:M})},$=()=>{g({...u,emails:[...u.emails,""]})},q=P=>{u.emails.length>1&&g({...u,emails:u.emails.filter((S,M)=>M!==P)})},k=(P,S)=>{const M=[...u.emails];M[P]=S,g({...u,emails:M})};return t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4 sm:p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-2xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsx("h1",{className:"text-center mb-2 text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:"Review Your Information"}),t.jsx("p",{className:"text-center mb-6 sm:mb-8 text-base sm:text-lg",style:{color:"var(--color-text-gray)"},children:"Please review and update your details if needed"}),t.jsxs("form",{onSubmit:I,className:"space-y-4 sm:space-y-6",children:[t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"First Name *"}),t.jsx("input",{type:"text",value:u.firstName,onChange:P=>g({...u,firstName:N(P.target.value)}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p.firstName?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"}}),p.firstName&&t.jsx("p",{className:"mt-1 text-sm",style:{color:"#EF4444"},children:p.firstName})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Last Name *"}),t.jsx("input",{type:"text",value:u.lastName,onChange:P=>g({...u,lastName:N(P.target.value)}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p.lastName?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"}}),p.lastName&&t.jsx("p",{className:"mt-1 text-sm",style:{color:"#EF4444"},children:p.lastName})]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Street Address *"}),t.jsx("input",{type:"text",value:u.street,onChange:P=>g({...u,street:N(P.target.value)}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p.street?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"}}),p.street&&t.jsx("p",{className:"mt-1 text-sm",style:{color:"#EF4444"},children:p.street})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Suite/Unit"}),t.jsx("input",{type:"text",value:u.suiteUnit,onChange:P=>g({...u,suiteUnit:P.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-4",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"City *"}),t.jsx("input",{type:"text",value:u.city,onChange:P=>g({...u,city:N(P.target.value)}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p.city?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"}}),p.city&&t.jsx("p",{className:"mt-1 text-sm",style:{color:"#EF4444"},children:p.city})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"State *"}),t.jsx("input",{type:"text",value:u.state,onChange:P=>g({...u,state:P.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p.state?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"}}),p.state&&t.jsx("p",{className:"mt-1 text-sm",style:{color:"#EF4444"},children:p.state})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"ZIP Code *"}),t.jsx("input",{type:"text",value:u.zip,onChange:P=>g({...u,zip:P.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p.zip?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"}}),p.zip&&t.jsx("p",{className:"mt-1 text-sm",style:{color:"#EF4444"},children:p.zip})]})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Country *"}),t.jsxs("select",{value:u.country,onChange:P=>g({...u,country:P.target.value}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:[t.jsx("option",{value:"USA",children:"USA"}),t.jsx("option",{value:"CAN",children:"CAN"}),t.jsx("option",{value:"MEX",children:"MEX"})]})]}),t.jsxs("div",{children:[t.jsxs("div",{className:"flex items-center justify-between mb-2",children:[t.jsx("label",{style:{color:"var(--color-text-gray)"},children:"Phone Number(s) *"}),t.jsx("button",{type:"button",onClick:L,className:"text-sm px-3 py-1 rounded",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"+ Add Phone"})]}),u.phones.map((P,S)=>t.jsxs("div",{className:"flex gap-2 mb-2",children:[t.jsx("input",{type:"tel",value:P,onChange:M=>F(S,M.target.value),placeholder:"(602) 555-1234",className:"flex-1 px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p[`phone${S}`]?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"}}),u.phones.length>1&&t.jsx("button",{type:"button",onClick:()=>C(S),className:"px-3 rounded",style:{backgroundColor:"#EF4444",color:"white"},children:"×"})]},S)),p.phones&&t.jsx("p",{className:"mt-1 text-sm",style:{color:"#EF4444"},children:p.phones})]}),t.jsxs("div",{children:[t.jsxs("div",{className:"flex items-center justify-between mb-2",children:[t.jsx("label",{style:{color:"var(--color-text-gray)"},children:"Email Address(es) *"}),t.jsx("button",{type:"button",onClick:$,className:"text-sm px-3 py-1 rounded",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"+ Add Email"})]}),u.emails.map((P,S)=>t.jsxs("div",{className:"flex gap-2 mb-2",children:[t.jsx("input",{type:"email",value:P,onChange:M=>k(S,M.target.value),placeholder:"email@example.com",className:"flex-1 px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p[`email${S}`]?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"}}),u.emails.length>1&&t.jsx("button",{type:"button",onClick:()=>q(S),className:"px-3 rounded",style:{backgroundColor:"#EF4444",color:"white"},children:"×"})]},S)),p.emails&&t.jsx("p",{className:"mt-1 text-sm",style:{color:"#EF4444"},children:p.emails})]}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2",children:[t.jsx("button",{type:"button",onClick:i,className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{type:"submit",className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Continue"})]})]})]})})}const lm=["Fabricator","Contractor","Kitchen & Bath","Architect","Builder","Friends/Family","Other"];function am({referralSources:s,onNext:d,onBack:i}){const[u,g]=f.useState(s.map(C=>C.type)),[p,x]=f.useState(s.reduce((C,F)=>(C[F.type]={name:F.name||"",phone:F.phone||""},C),{})),N=C=>C.split(" ").map(F=>F.charAt(0).toUpperCase()+F.slice(1).toLowerCase()).join(" "),b=C=>{if(u.includes(C)){g(u.filter($=>$!==C));const F={...p};delete F[C],x(F)}else g([...u,C])},I=(C,F,$)=>{x({...p,[C]:{...p[C],name:F==="name"?$:p[C]?.name||"",phone:F==="phone"?$:p[C]?.phone||""}})},L=C=>{if(C.preventDefault(),u.length===0){alert("Please select at least one referral source");return}for(const $ of u){if(!p[$]?.name?.trim()){alert(`Please enter a name for ${$}`);return}if($!=="Fabricator"&&!p[$]?.phone?.trim()){alert(`Please enter a phone number for ${$}`);return}}const F=u.map($=>({type:$,name:p[$]?.name,phone:p[$]?.phone}));d(F)};return t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4 sm:p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-2xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsx("h1",{className:"text-center mb-2 text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:"Review Referral Sources"}),t.jsx("p",{className:"text-center mb-6 sm:mb-8 text-base sm:text-lg font-medium",style:{color:"var(--color-text-gray)"},children:"Update or add new referral sources"}),t.jsxs("form",{onSubmit:L,className:"space-y-4 sm:space-y-6",children:[t.jsx("div",{className:"space-y-4",children:lm.map(C=>t.jsxs("div",{children:[t.jsxs("label",{className:"flex items-center gap-3 cursor-pointer p-3 sm:p-4 rounded-lg hover:bg-opacity-50 transition-colors",style:{backgroundColor:u.includes(C)?"var(--color-background)":"transparent",border:`1px solid ${u.includes(C)?"var(--color-gold)":"var(--color-border)"}`},children:[t.jsx("input",{type:"checkbox",checked:u.includes(C),onChange:()=>b(C),className:"w-5 h-5 flex-shrink-0",style:{accentColor:"var(--color-gold)"}}),t.jsx("span",{className:"text-sm sm:text-base",style:{color:"var(--color-text-white)"},children:C})]}),u.includes(C)&&t.jsxs("div",{className:"ml-6 sm:ml-8 mt-3 space-y-3",children:[t.jsx("input",{type:"text",value:p[C]?.name||"",onChange:F=>I(C,"name",N(F.target.value)),placeholder:"Name (required)",required:!0,className:"w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}}),t.jsx("input",{type:"tel",value:p[C]?.phone||"",onChange:F=>I(C,"phone",F.target.value),placeholder:C==="Fabricator"?"Phone (optional)":"Phone (required)",required:C!=="Fabricator",className:"w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]})]},C))}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2",children:[t.jsx("button",{type:"button",onClick:i,className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{type:"submit",className:"w-full sm:flex-1 py-3 sm:py-4 rounded-lg text-sm sm:text-base",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Continue"})]})]})]})})}function sm({customerName:s,onSubmit:d,onBack:i}){const[u,g]=f.useState("party"),[p,x]=f.useState({adults:1,minors:0}),[N,b]=f.useState(!1),[I,L]=f.useState(""),[C,F]=f.useState([]),[$,q]=f.useState(0),[k,P]=f.useState([]),[S,M]=f.useState(0),[B,X]=f.useState(""),W=f.useRef(null),[R,E]=f.useState(!1),[K,_]=f.useState(!1);f.useEffect(()=>{const j=W.current;if(j){const oe=j.getContext("2d");oe&&(oe.strokeStyle="#D4A736",oe.lineWidth=2,oe.lineCap="round")}},[u,$]);const A=(j,oe)=>{const le=oe.getBoundingClientRect(),U=oe.width/le.width,Y=oe.height/le.height,de="touches"in j?j.touches[0].clientX:j.clientX,be="touches"in j?j.touches[0].clientY:j.clientY;return{x:(de-le.left)*U,y:(be-le.top)*Y}},ee=j=>{E(!0);const oe=W.current;if(!oe)return;const le=oe.getContext("2d");if(!le)return;const{x:U,y:Y}=A(j,oe);le.beginPath(),le.moveTo(U,Y)},ne=j=>{if(!R)return;const oe=W.current;if(!oe)return;const le=oe.getContext("2d");if(!le)return;const{x:U,y:Y}=A(j,oe);le.lineTo(U,Y),le.stroke()},pe=()=>{E(!1),_(!0)},Ce=()=>{const j=W.current;if(!j)return;const oe=j.getContext("2d");oe&&(oe.clearRect(0,0,j.width,j.height),_(!1))},Ee=()=>{const j=W.current;return j?j.toDataURL("image/png"):""},Me=()=>{g("main")},Pe=()=>{if(!N){alert("Please agree to the terms before continuing");return}if(!K){alert("Please provide your signature");return}const j=Ee();L(j),Ce(),p.adults>1?(g("additional"),q(0)):p.minors>0?(g("minors"),M(0)):te(j,[],[])},J=()=>{const j=document.getElementById("additional-name")?.value;if(!j||!j.trim()){alert("Please enter a name");return}if(!K){alert("Please provide a signature");return}const oe=Ee(),le=[...C];le[$]={name:j.trim(),signature:oe},F(le),Ce(),$<p.adults-2?q($+1):p.minors>0?(g("minors"),M(0)):te(I,le,[])},ce=()=>{if(!B.trim()){alert("Please enter the minor's name");return}const j=[...k];j[S]=B.trim(),P(j),X(""),S<p.minors-1?M(S+1):te(I,C,j)},te=(j,oe,le)=>{const U=[{name:s,signature:j,isMain:!0,isMinor:!1},...oe.map(Y=>({name:Y.name,signature:Y.signature,isMain:!1,isMinor:!1})),...le.map(Y=>({name:Y,signature:"",isMain:!1,isMinor:!0}))];d({partySize:p,signature:j,visitors:U})},h=()=>{u==="party"?i():u==="main"?g("party"):u==="additional"?$===0?g("main"):q($-1):u==="minors"&&(S===0?p.adults>1?(g("additional"),q(p.adults-2)):g("main"):M(S-1))};return u==="party"?t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4 sm:p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-md",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsx("h1",{className:"text-center mb-2 text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:"Party Size"}),t.jsx("p",{className:"text-center mb-6 sm:mb-8 text-base sm:text-lg",style:{color:"var(--color-text-gray)"},children:"How many people are in your party?"}),t.jsxs("div",{className:"space-y-6",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Number of Adults (including you)"}),t.jsx("input",{type:"number",min:"1",max:"20",value:p.adults,onChange:j=>x({...p,adults:parseInt(j.target.value)||1}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Number of Minors (under 18)"}),t.jsx("input",{type:"number",min:"0",max:"20",value:p.minors,onChange:j=>x({...p,minors:parseInt(j.target.value)||0}),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 pt-2",children:[t.jsx("button",{type:"button",onClick:h,className:"w-full sm:flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{onClick:Me,className:"w-full sm:flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Continue"})]})]})]})}):u==="main"?t.jsx("div",{className:"min-h-screen flex items-start justify-center p-4 sm:p-6 pt-8 pb-10",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-3xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsx("h1",{className:"text-center mb-2 text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:"Liability Waiver"}),t.jsx("p",{className:"text-center mb-6 text-base sm:text-lg",style:{color:"var(--color-text-gray)"},children:"Please read and sign below"}),t.jsxs("div",{className:"space-y-4 sm:space-y-6",children:[t.jsx("div",{className:"rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",padding:"16px",color:"var(--color-text-white)",lineHeight:"1.6",fontSize:"13px"},children:t.jsx("p",{style:{whiteSpace:"pre-wrap"},children:`WAIVER AND RELEASE, INDEMNITY AGREEMENT, AND INFORMED CONSENT
...
I HAVE READ THIS COVENANT NOT TO SUE, WAIVER, RELEASE, INFORMED CONSENT, ASSUMPTION OF RISK AND INDEMNITY AGREEMENT, FULLY UNDERSTAND ITS TERMS, UNDERSTAND THAT I HAVE GIVEN UP SUBSTANTIAL RIGHTS BY SIGNING IT, AND HAVE SIGNED IT FREELY AND VOLUNTARILY WITHOUT ANY INDUCEMENT, ASSURANCE OR GUARANTEE BEING MADE TO ME AND INTEND MY SIGNATURE TO BE A COMPLETE AND UNCONDITIONAL RELEASE OF RELIANCE AND ALL PARTIES MENTIONED HEREIN TO THE GREATEST EXTENT ALLOWED BY LAW. THIS IS A RELEASE OF LIABILITY; DO NOT SIGN THIS DOCUMENT IF YOU DO NOT UNDERSTAND OR DO NOT AGREE WITH ITS TERMS.`})}),t.jsx("div",{children:t.jsxs("label",{className:"flex items-center gap-3 cursor-pointer",children:[t.jsx("input",{type:"checkbox",checked:N,onChange:j=>b(j.target.checked),className:"w-5 h-5",style:{accentColor:"var(--color-gold)"}}),t.jsx("span",{style:{color:"var(--color-text-white)"},children:"I have read and agree to the terms above"})]})}),t.jsxs("div",{children:[t.jsxs("div",{className:"flex items-center justify-between mb-2",children:[t.jsx("label",{style:{color:"var(--color-text-gray)"},children:"Your Signature"}),t.jsx("button",{type:"button",onClick:Ce,className:"text-sm px-3 py-1 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Clear"})]}),t.jsx("canvas",{ref:W,width:600,height:220,onMouseDown:ee,onMouseMove:ne,onMouseUp:pe,onMouseLeave:pe,onTouchStart:ee,onTouchMove:ne,onTouchEnd:pe,className:"w-full border rounded-lg cursor-crosshair",style:{backgroundColor:"var(--color-background)",border:"2px solid var(--color-gold)"}})]}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 pt-2",children:[t.jsx("button",{type:"button",onClick:h,className:"w-full sm:flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{onClick:Pe,className:"w-full sm:flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:p.adults>1||p.minors>0?"Next":"Submit"})]})]})]})}):u==="additional"?t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4 sm:p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-2xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsxs("h1",{className:"text-center mb-2 text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:["Visitor ",$+2," of ",p.adults]}),t.jsx("p",{className:"text-center mb-6 sm:mb-8 text-base sm:text-lg",style:{color:"var(--color-text-gray)"},children:"Additional adult signature required"}),t.jsxs("div",{className:"space-y-6",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Full Name"}),t.jsx("input",{id:"additional-name",type:"text",defaultValue:C[$]?.name||"",className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},placeholder:"Enter full name"})]}),t.jsxs("div",{children:[t.jsxs("div",{className:"flex items-center justify-between mb-2",children:[t.jsx("label",{style:{color:"var(--color-text-gray)"},children:"Signature"}),t.jsx("button",{type:"button",onClick:Ce,className:"text-sm px-3 py-1 rounded",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Clear"})]}),t.jsx("canvas",{ref:W,width:600,height:220,onMouseDown:ee,onMouseMove:ne,onMouseUp:pe,onMouseLeave:pe,onTouchStart:ee,onTouchMove:ne,onTouchEnd:pe,className:"w-full border rounded-lg cursor-crosshair",style:{backgroundColor:"var(--color-background)",border:"2px solid var(--color-gold)"}})]}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 pt-2",children:[t.jsx("button",{type:"button",onClick:h,className:"w-full sm:flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{onClick:J,className:"w-full sm:flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:$<p.adults-2||p.minors>0?"Next":"Submit"})]})]})]})}):u==="minors"?t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4 sm:p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-md",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"24px"},children:[t.jsxs("h1",{className:"text-center mb-2 text-2xl sm:text-3xl",style:{color:"var(--color-gold)"},children:["Minor ",S+1," of ",p.minors]}),t.jsx("p",{className:"text-center mb-6 sm:mb-8 text-base sm:text-lg",style:{color:"var(--color-text-gray)"},children:"Please provide the minor's name"}),t.jsxs("div",{className:"space-y-6",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Full Name"}),t.jsx("input",{type:"text",value:B,onChange:j=>X(j.target.value),className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},placeholder:"Enter full name"})]}),t.jsx("p",{className:"text-sm text-center",style:{color:"var(--color-text-gray)"},children:"No signature required (under 18)"}),t.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 pt-2",children:[t.jsx("button",{type:"button",onClick:h,className:"w-full sm:flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Back"}),t.jsx("button",{onClick:ce,className:"w-full sm:flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:S<p.minors-1?"Next":"Submit"})]})]})]})}):null}function im({customerName:s,onReturnHome:d}){const[i,u]=f.useState(15),g=f.useRef(d);return f.useEffect(()=>{g.current=d},[d]),f.useEffect(()=>{const p=setInterval(()=>{u(x=>x<=1?(clearInterval(p),setTimeout(()=>g.current(),0),0):x-1)},1e3);return()=>clearInterval(p)},[]),t.jsx("div",{className:"min-h-screen flex items-center justify-center p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-2xl text-center",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"48px"},children:[t.jsx("div",{className:"flex justify-center mb-6",children:t.jsx(xs,{size:80,style:{color:"var(--color-success)"}})}),t.jsxs("h1",{className:"mb-4",style:{color:"var(--color-gold)"},children:["Thank You for Revisiting, ",s,"!"]}),t.jsx("p",{className:"mb-8",style:{color:"var(--color-text-white)",fontSize:"18px"},children:"Your check-in is complete. A member of our team will be with you shortly."}),t.jsxs("p",{className:"mb-6",style:{color:"var(--color-text-gray)"},children:["Returning to home screen in ",t.jsx("span",{style:{color:"var(--color-gold)"},children:i})," seconds..."]}),t.jsx("button",{onClick:d,className:"px-8 py-4 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Return to Home"})]})})}function cm({onLogin:s}){const[d,i]=f.useState(""),[u,g]=f.useState(""),[p,x]=f.useState(""),N=b=>{b.preventDefault(),x(""),d==="staff2"&&u==="reliance"?s(d):x("Invalid credentials. Use staff2/reliance")};return t.jsx("div",{className:"min-h-screen flex items-center justify-center p-4",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-md",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"32px"},children:[t.jsx("h1",{className:"text-center mb-2 text-3xl",style:{color:"var(--color-gold)"},children:"Staff2 Login"}),t.jsx("p",{className:"text-center mb-8",style:{color:"var(--color-text-gray)"},children:"Queue Management"}),t.jsxs("form",{onSubmit:N,className:"space-y-6",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Username"}),t.jsx("input",{type:"text",value:d,onChange:b=>{i(b.target.value),x("")},className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"},placeholder:"Enter username"})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-gray)"},children:"Password"}),t.jsx("input",{type:"password",value:u,onChange:b=>{g(b.target.value),x("")},className:"w-full px-4 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:`1px solid ${p?"#EF4444":"var(--color-border)"}`,color:"var(--color-text-white)"},placeholder:"Enter password"})]}),p&&t.jsx("div",{className:"p-3 rounded-lg",style:{backgroundColor:"rgba(239, 68, 68, 0.1)",border:"1px solid #EF4444"},children:t.jsx("p",{style:{color:"#EF4444",fontSize:"14px"},children:p})}),t.jsx("button",{type:"submit",className:"w-full py-3 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Login"})]})]})})}const Md=["Katia","Diane","Sathvik","Ben","Dheeraj","Om","Raj","Alana","Aman","Maria","Susheel","Harsh","Walter","Olivia","Shaik","Swatik","Ras","Self","Jugal","Preet","Lenny"];function dm({customer:s,currentUsername:d,onView:i,onDone:u,onAssign:g}){const p=(s.partySize?.adults||0)+(s.partySize?.minors||0),x=s.isRevisit===!0,N=s.currentlyHelpedBy||"",b=I=>{if(!I)return"";const L=new Date(I);return isNaN(L.getTime())?"":L.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})};return t.jsx("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:N?"1px solid rgba(34, 197, 94, 0.4)":"1px solid var(--color-border)"},children:t.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between",children:[t.jsxs("div",{className:"flex items-center gap-3 flex-1 min-w-0",children:[t.jsx("div",{className:"w-10 h-10 rounded-full flex items-center justify-center font-bold flex-shrink-0",style:{backgroundColor:"rgba(212, 167, 54, 0.2)",color:"var(--color-gold)"},children:s.firstName?.charAt(0).toUpperCase()||"?"}),t.jsxs("div",{className:"flex flex-col gap-1 min-w-0",children:[t.jsxs("div",{className:"flex items-center gap-3 flex-wrap",children:[t.jsx("p",{className:"font-medium whitespace-nowrap",style:{color:"var(--color-text-white)"},children:[s.firstName,s.lastName].filter(Boolean).join(" ")}),t.jsx("p",{className:"text-sm whitespace-nowrap",style:{color:"var(--color-text-gray)"},children:s.phones?.[0]||"No phone"}),t.jsx("span",{className:"px-2 py-0.5 rounded text-xs font-medium whitespace-nowrap",style:{backgroundColor:x?"rgba(212, 167, 54, 0.2)":"rgba(59, 130, 246, 0.2)",color:x?"var(--color-gold)":"#3B82F6"},children:x?"Revisiting":"First Time"}),t.jsxs("p",{className:"text-sm whitespace-nowrap",style:{color:"var(--color-text-gray)"},children:["👥 ",p," visitor",p!==1?"s":""]}),s.checkInTime&&t.jsxs("p",{className:"text-sm whitespace-nowrap",style:{color:"var(--color-text-gray)"},children:["🕐 ",b(s.checkInTime)]})]}),N&&t.jsxs("p",{className:"text-xs",style:{color:"#22C55E"},children:["✓ Assigned to ",N]})]})]}),t.jsxs("div",{className:"flex items-center gap-2 flex-shrink-0",children:[t.jsxs("select",{value:N,onChange:I=>g(s.id,I.target.value),className:"px-3 py-2 rounded-lg font-medium",style:{backgroundColor:N?"rgba(34, 197, 94, 0.1)":"var(--color-background)",border:N?"1px solid #22C55E":"1px solid var(--color-border)",color:N?"#22C55E":"var(--color-text-white)",cursor:"pointer"},children:[t.jsx("option",{value:"",style:{backgroundColor:"var(--color-card)",color:"var(--color-text-white)"},children:"— Assign —"}),Md.map(I=>t.jsx("option",{value:I,style:{backgroundColor:"var(--color-card)",color:"var(--color-text-white)"},children:I},I))]}),t.jsx("button",{onClick:()=>i(s),className:"px-4 py-2 rounded-lg font-medium whitespace-nowrap",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"View"}),t.jsx("button",{onClick:()=>u(s.id),className:"px-4 py-2 rounded-lg font-medium whitespace-nowrap",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Done"})]})]})})}function um({customer:s,onClose:d,onSave:i}){const[u,g]=f.useState([s.firstName,s.lastName].filter(Boolean).join(" ")),[p,x]=f.useState({street:s.street||"",suiteUnit:s.suiteUnit||"",city:s.city||"",state:s.state||"",zip:s.zip||"",country:s.country||"USA",phones:s.phones||[""],emails:s.emails||[""]}),N=E=>E.split(" ").map(K=>K.charAt(0).toUpperCase()+K.slice(1).toLowerCase()).join(" "),b=()=>{x({...p,phones:[...p.phones,""]})},I=E=>{p.phones.length>1&&x({...p,phones:p.phones.filter((K,_)=>_!==E)})},L=(E,K)=>{const _=[...p.phones];_[E]=K,x({...p,phones:_})},C=()=>{x({...p,emails:[...p.emails,""]})},F=E=>{p.emails.length>1&&x({...p,emails:p.emails.filter((K,_)=>_!==E)})},$=(E,K)=>{const _=[...p.emails];_[E]=K,x({...p,emails:_})},[q,k]=f.useState([]),[P,S]=f.useState(!1),[M,B]=f.useState(!1),[X,W]=f.useState(null);f.useEffect(()=>{const E=s.phones?.[0];E&&(B(!0),fetch(`/api/images/customer/${encodeURIComponent(E)}`).then(K=>K.json()).then(K=>{K.success&&Array.isArray(K.data)&&k(K.data.filter(_=>_.images.length>0))}).catch(()=>{}).finally(()=>B(!1)))},[s.phones]);const R=()=>{if(!u.trim()){alert("Full name is required");return}const E=u.trim().split(/\s+/),K=E[0]||"",_=E.slice(1).join(" ");i(s.id,{firstName:K,lastName:_,...p})};return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"fixed inset-0 flex items-center justify-center p-6 z-50",style:{backgroundColor:"rgba(0, 0, 0, 0.8)"},children:t.jsxs("div",{className:"w-full max-w-4xl max-h-[90vh] overflow-y-auto",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"32px"},children:[t.jsxs("div",{className:"flex justify-between items-start mb-6",children:[t.jsxs("div",{children:[t.jsx("h2",{className:"text-2xl",style:{color:"var(--color-gold)"},children:[s.firstName,s.lastName].filter(Boolean).join(" ")}),t.jsx("p",{className:"text-sm mt-1",style:{color:"var(--color-text-gray)"},children:s.isRevisit?"Revisiting Customer":"First Time Customer"})]}),t.jsx("button",{onClick:d,className:"p-2 rounded-lg hover:bg-opacity-50",style:{backgroundColor:"var(--color-background)",color:"var(--color-text-gray)"},children:t.jsx(ct,{size:24})})]}),t.jsxs("div",{className:"mb-8",children:[t.jsx("h3",{className:"text-xl mb-4",style:{color:"var(--color-text-white)"},children:"Customer Information"}),t.jsxs("div",{className:"mb-4",children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"Full Name *"}),t.jsx("input",{type:"text",value:u,onChange:E=>g(N(E.target.value)),className:"w-full px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{className:"mb-4",children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"Street Address"}),t.jsx("input",{type:"text",value:p.street,onChange:E=>x({...p,street:N(E.target.value)}),className:"w-full px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{className:"mb-4",children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"Suite/Unit"}),t.jsx("input",{type:"text",value:p.suiteUnit,onChange:E=>x({...p,suiteUnit:E.target.value}),className:"w-full px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"City"}),t.jsx("input",{type:"text",value:p.city,onChange:E=>x({...p,city:N(E.target.value)}),className:"w-full px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"State"}),t.jsx("input",{type:"text",value:p.state,onChange:E=>x({...p,state:E.target.value}),className:"w-full px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"ZIP"}),t.jsx("input",{type:"text",value:p.zip,onChange:E=>x({...p,zip:E.target.value}),className:"w-full px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]})]}),t.jsxs("div",{className:"mb-4",children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"Phones"}),p.phones.map((E,K)=>t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("input",{type:"text",value:E,onChange:_=>L(K,_.target.value),className:"w-full px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}}),t.jsx("button",{onClick:()=>I(K),className:"p-2 rounded-lg hover:bg-opacity-50",style:{backgroundColor:"var(--color-background)",color:"var(--color-text-gray)"},children:t.jsx(ct,{size:16})})]},K)),t.jsx("button",{onClick:b,className:"py-2 px-4 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Add Phone"})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"Emails"}),p.emails.map((E,K)=>t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("input",{type:"text",value:E,onChange:_=>$(K,_.target.value),className:"w-full px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}}),t.jsx("button",{onClick:()=>F(K),className:"p-2 rounded-lg hover:bg-opacity-50",style:{backgroundColor:"var(--color-background)",color:"var(--color-text-gray)"},children:t.jsx(ct,{size:16})})]},K)),t.jsx("button",{onClick:C,className:"py-2 px-4 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Add Email"})]})]}),s.referralSources&&s.referralSources.length>0&&t.jsxs("div",{className:"mb-8",children:[t.jsx("h3",{className:"text-xl mb-4",style:{color:"var(--color-text-white)"},children:"Referral Information"}),t.jsx("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)"},children:s.referralSources.map((E,K)=>t.jsxs("div",{className:"mb-3 last:mb-0",children:[t.jsxs("p",{style:{color:"var(--color-gold)"},children:["• ",E.type]}),E.name&&t.jsxs("p",{className:"ml-4 text-sm",style:{color:"var(--color-text-gray)"},children:["Name: ",E.name]}),E.phone&&t.jsxs("p",{className:"ml-4 text-sm",style:{color:"var(--color-text-gray)"},children:["Phone: ",E.phone]}),E.location&&t.jsxs("p",{className:"ml-4 text-sm",style:{color:"var(--color-text-gray)"},children:["Location: ",E.location]})]},K))})]}),s.partySize&&t.jsxs("div",{className:"mb-8",children:[t.jsx("h3",{className:"text-xl mb-4",style:{color:"var(--color-text-white)"},children:"Party Information"}),t.jsxs("div",{className:"grid grid-cols-2 gap-4 mb-4",children:[t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Adults"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:s.partySize.adults})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Minors"}),t.jsx("p",{className:"text-2xl",style:{color:"var(--color-gold)"},children:s.partySize.minors})]})]}),s.visitors&&s.visitors.length>0&&t.jsxs("div",{children:[t.jsx("h4",{className:"text-lg mb-3",style:{color:"var(--color-text-white)"},children:"Visitors & Signatures"}),t.jsx("div",{className:"space-y-4",children:s.visitors.map((E,K)=>t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-background)",border:E.isMain?"2px solid var(--color-gold)":"1px solid var(--color-border)"},children:[t.jsxs("div",{className:"flex items-center gap-2 mb-3",children:[t.jsx("span",{className:"font-medium",style:{color:"var(--color-text-white)"},children:E.name}),E.isMain&&t.jsx("span",{className:"px-2 py-0.5 rounded text-xs",style:{backgroundColor:"rgba(212, 167, 54, 0.2)",color:"var(--color-gold)"},children:"Main"}),E.isMinor&&t.jsx("span",{className:"px-2 py-0.5 rounded text-xs",style:{backgroundColor:"rgba(100, 100, 100, 0.2)",color:"var(--color-text-gray)"},children:"Minor (No signature required)"})]}),E.signature&&!E.isMinor&&t.jsxs("div",{children:[t.jsx("p",{className:"text-xs mb-2",style:{color:"var(--color-text-gray)"},children:"Signature:"}),t.jsx("div",{className:"rounded-lg overflow-hidden",style:{backgroundColor:"white",border:"1px solid var(--color-border)",maxWidth:"400px"},children:t.jsx("img",{src:E.signature,alt:`${E.name} signature`,style:{width:"100%",height:"auto",maxHeight:"150px",objectFit:"contain"}})})]})]},K))})]})]}),t.jsxs("div",{className:"mb-8 rounded-lg overflow-hidden",style:{border:"1px solid var(--color-border)"},children:[t.jsxs("button",{onClick:()=>S(E=>!E),className:"w-full flex items-center justify-between px-4 py-3",style:{backgroundColor:"var(--color-background)",color:"var(--color-text-white)",border:"none",cursor:"pointer"},children:[t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx(ys,{size:16,style:{color:"var(--color-gold)"}}),t.jsx("span",{children:"Uploaded Images"}),!M&&t.jsx("span",{className:"px-2 py-0.5 rounded text-xs",style:{backgroundColor:"rgba(212,167,54,0.15)",color:"var(--color-gold)"},children:q.reduce((E,K)=>E+K.images.length,0)})]}),P?t.jsx(kd,{size:16,style:{color:"var(--color-text-gray)"}}):t.jsx(bd,{size:16,style:{color:"var(--color-text-gray)"}})]}),P&&t.jsx("div",{className:"p-4",style:{borderTop:"1px solid var(--color-border)"},children:M?t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"Loading…"}):q.length===0?t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"14px"},children:"No images uploaded."}):t.jsx("div",{className:"space-y-5",children:q.map(E=>t.jsxs("div",{children:[q.length>1&&t.jsxs("p",{className:"mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:["Visit: ",new Date(E.checkInTime).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})]}),t.jsx("div",{className:"grid gap-3",style:{gridTemplateColumns:"repeat(auto-fill, minmax(110px, 1fr))"},children:E.images.map(K=>t.jsxs("div",{className:"relative rounded-lg overflow-hidden",style:{aspectRatio:"1",border:"1px solid var(--color-border)",cursor:"pointer"},onClick:()=>W(K.image_url),children:[t.jsx("img",{src:K.image_url,alt:"Material",className:"w-full h-full object-cover"}),t.jsxs("div",{className:"absolute bottom-0 right-0 px-1.5 py-0.5 text-xs font-semibold rounded-tl-lg",style:{backgroundColor:"rgba(0,0,0,0.75)",color:"var(--color-gold)"},children:["×",K.quantity]})]},K.id))})]},E.checkInId))})})]}),t.jsxs("div",{className:"flex gap-3",children:[t.jsx("button",{onClick:d,className:"flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:"Cancel"}),t.jsx("button",{onClick:R,className:"flex-1 py-3 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Save Changes"})]})]})}),X&&t.jsxs("div",{style:{position:"fixed",inset:0,zIndex:9999,backgroundColor:"rgba(0,0,0,0.9)",display:"flex",alignItems:"center",justifyContent:"center",padding:"16px"},onClick:()=>W(null),children:[t.jsx("img",{src:X,alt:"Enlarged material",style:{maxWidth:"90vw",maxHeight:"90vh",display:"block",borderRadius:"8px"},onClick:E=>E.stopPropagation()}),t.jsx("button",{onClick:()=>W(null),style:{position:"absolute",top:"16px",right:"16px",width:"40px",height:"40px",borderRadius:"50%",backgroundColor:"rgba(255,255,255,0.2)",color:"white",fontSize:"22px",border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"},children:"×"})]})]})}function pm({username:s,onLogout:d,checkIns:i,onMarkAsDone:u}){const[g,p]=f.useState("queue"),[x,N]=f.useState([]),[b,I]=f.useState([]),[L,C]=f.useState(null),[F,$]=f.useState(!1),[q,k]=f.useState(1),[P,S]=f.useState(1),M=15,[B,X]=f.useState(new Date().getMonth()+1),[W,R]=f.useState(new Date().getDate()),[E,K]=f.useState(new Date().getFullYear()),[_,A]=f.useState(i),[ee,ne]=f.useState(0);f.useEffect(()=>{const U=_.filter(Y=>Y.status==="waiting").sort((Y,de)=>new Date(Y.checkInTime).getTime()-new Date(de.checkInTime).getTime());N(U)},[_]),f.useEffect(()=>{if(g!=="history")return;const U=String(B).padStart(2,"0"),Y=String(W).padStart(2,"0");fetch(`/api/check-ins?date=${E}-${U}-${Y}`).then(de=>de.json()).then(de=>{de.success&&Array.isArray(de.data)&&I(de.data)}).catch(()=>{})},[g,B,W,E,ee]),f.useEffect(()=>{fetch("/api/check-ins").then(Y=>Y.json()).then(Y=>{Y.success&&Array.isArray(Y.data)&&A(Y.data)}).catch(()=>{});const U=new EventSource("/api/check-ins/events");return U.onmessage=Y=>{try{const de=JSON.parse(Y.data);de.type==="update"&&Array.isArray(de.data)&&(A(de.data),ne(be=>be+1))}catch{}},U.onerror=()=>{},()=>U.close()},[]);const pe=async U=>{C(U),$(!0);try{const de=await(await fetch(`/api/check-ins/${U.id}`)).json();de.success&&de.data&&C(de.data)}catch{}},Ce=async U=>{const Y=new Date().toISOString(),be=_.find(ye=>ye.id===U)?.currentlyHelpedBy||null;A(ye=>ye.map(Oe=>Oe.id===U?{...Oe,status:"done",helpedTime:Y,helpedBy:be}:Oe));try{await fetch(`/api/check-ins/${U}/done`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({helpedBy:be})})}catch{A(ye=>ye.map(Oe=>Oe.id===U?{...Oe,status:"waiting",helpedTime:null}:Oe))}u(U)},Ee=async(U,Y)=>{A(de=>de.map(be=>be.id===U?{...be,currentlyHelpedBy:Y||null}:be));try{await fetch(`/api/check-ins/${U}/claim`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({helpedBy:Y})})}catch{}},Me=async(U,Y)=>{A(de=>de.map(be=>be.id===U?{...be,...Y}:be)),$(!1)},Pe=b.length,J=b.filter(U=>!U.isRevisit).length,ce=b.filter(U=>U.isRevisit).length,te={};for(const U of b){const Y=U.helpedBy;Y&&(te[Y]=(te[Y]||0)+1)}const h=Md.filter(U=>te[U]).map(U=>({name:U,count:te[U]})),j=["January","February","March","April","May","June","July","August","September","October","November","December"],oe=Array.from({length:31},(U,Y)=>Y+1),le=[2024,2025,2026,2027];return t.jsxs("div",{className:"min-h-screen",style:{backgroundColor:"var(--color-background)"},children:[t.jsx("header",{className:"border-b",style:{backgroundColor:"var(--color-card)",borderColor:"var(--color-border)"},children:t.jsxs("div",{className:"flex items-center justify-between px-6 py-4",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("img",{src:Jt,alt:"Reliance Surfaces",className:"w-10 h-10 object-contain"}),t.jsx("span",{className:"text-xl font-medium",style:{color:"var(--color-text-white)"},children:"Reliance Surfaces"})]}),t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsxs("span",{style:{color:"var(--color-text-gray)"},children:["Welcome, ",s]}),t.jsxs("button",{onClick:d,className:"flex items-center gap-2 px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:[t.jsx(un,{size:18}),"Logout"]})]})]})}),t.jsx("div",{className:"border-b",style:{backgroundColor:"var(--color-card)",borderColor:"var(--color-border)"},children:t.jsxs("div",{className:"flex px-6",children:[t.jsxs("button",{onClick:()=>p("queue"),className:"px-6 py-4 font-medium border-b-2",style:{color:g==="queue"?"var(--color-gold)":"var(--color-text-gray)",borderColor:g==="queue"?"var(--color-gold)":"transparent"},children:["Queue (",x.length,")"]}),t.jsx("button",{onClick:()=>p("history"),className:"px-6 py-4 font-medium border-b-2",style:{color:g==="history"?"var(--color-gold)":"var(--color-text-gray)",borderColor:g==="history"?"var(--color-gold)":"transparent"},children:"History"})]})}),t.jsx("div",{className:"p-6",children:g==="queue"?t.jsxs("div",{children:[t.jsx("h2",{className:"text-2xl mb-6",style:{color:"var(--color-text-white)"},children:"Customer Queue"}),x.length===0?t.jsx("div",{className:"text-center py-12 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:t.jsx("p",{style:{color:"var(--color-text-gray)"},children:"No customers in queue"})}):t.jsx("div",{className:"space-y-4",children:x.slice((q-1)*M,q*M).map(U=>t.jsx(dm,{customer:U,currentUsername:s,onView:pe,onDone:Ce,onAssign:Ee},U.id))}),x.length>M&&t.jsxs("div",{className:"flex justify-center mt-4",children:[t.jsx("button",{onClick:()=>k(q-1),disabled:q===1,className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Previous"}),t.jsxs("span",{className:"mx-4",style:{color:"var(--color-text-gray)"},children:["Page ",q," of ",Math.ceil(x.length/M)]}),t.jsx("button",{onClick:()=>k(q+1),disabled:q*M>=x.length,className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Next"})]})]}):t.jsxs("div",{children:[t.jsxs("div",{className:"mb-6",children:[t.jsx("h2",{className:"text-2xl mb-4",style:{color:"var(--color-text-white)"},children:"Daily Visitors"}),t.jsxs("div",{className:"flex flex-wrap gap-4 mb-6",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"Month"}),t.jsx("select",{value:B,onChange:U=>{X(parseInt(U.target.value)),S(1)},className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:j.map((U,Y)=>t.jsx("option",{value:Y+1,children:U},Y))})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"Day"}),t.jsx("select",{value:W,onChange:U=>{R(parseInt(U.target.value)),S(1)},className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:oe.map(U=>t.jsx("option",{value:U,children:U},U))})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-2 text-sm",style:{color:"var(--color-text-gray)"},children:"Year"}),t.jsx("select",{value:E,onChange:U=>{K(parseInt(U.target.value)),S(1)},className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:le.map(U=>t.jsx("option",{value:U,children:U},U))})]})]}),t.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6",children:[t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Total Visitors"}),t.jsx("p",{className:"text-3xl font-bold",style:{color:"var(--color-gold)"},children:Pe})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"New Customers"}),t.jsx("p",{className:"text-3xl font-bold",style:{color:"#3B82F6"},children:J})]}),t.jsxs("div",{className:"p-4 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm mb-1",style:{color:"var(--color-text-gray)"},children:"Revisits"}),t.jsx("p",{className:"text-3xl font-bold",style:{color:"var(--color-gold)"},children:ce})]})]}),h.length>0&&t.jsxs("div",{className:"p-4 rounded-lg mb-6",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{className:"text-sm font-medium mb-3",style:{color:"var(--color-text-gray)"},children:"Staff Summary"}),t.jsx("div",{className:"flex flex-wrap gap-3",children:h.map(({name:U,count:Y})=>t.jsxs("div",{className:"flex items-center gap-2 px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)"},children:[t.jsx("span",{style:{color:"var(--color-text-white)"},children:U}),t.jsx("span",{className:"px-2 py-0.5 rounded-full text-xs font-bold",style:{backgroundColor:"rgba(212, 167, 54, 0.2)",color:"var(--color-gold)"},children:Y})]},U))})]})]}),b.length===0?t.jsx("div",{className:"text-center py-12 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:t.jsx("p",{style:{color:"var(--color-text-gray)"},children:"No visitors for selected date"})}):t.jsx("div",{className:"space-y-4",children:b.slice((P-1)*M,P*M).map(U=>t.jsx("div",{className:"p-4 rounded-lg cursor-pointer hover:opacity-80 transition-opacity",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},onClick:()=>pe(U),children:t.jsxs("div",{className:"flex items-center justify-between",children:[t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsx("div",{className:"w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg",style:{backgroundColor:"rgba(212, 167, 54, 0.2)",color:"var(--color-gold)"},children:U.firstName?.charAt(0).toUpperCase()||"?"}),t.jsxs("div",{children:[t.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[t.jsx("p",{className:"font-medium",style:{color:"var(--color-text-white)"},children:[U.firstName,U.lastName].filter(Boolean).join(" ")}),t.jsx("span",{className:"px-2 py-0.5 rounded text-xs",style:{backgroundColor:U.isRevisit?"rgba(212, 167, 54, 0.2)":"rgba(59, 130, 246, 0.2)",color:U.isRevisit?"var(--color-gold)":"#3B82F6"},children:U.isRevisit?"Revisiting":"First Time"})]}),t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("p",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:U.phones?.[0]||"No phone"}),U.helpedBy&&t.jsxs("p",{className:"text-xs",style:{color:"#22C55E"},children:["✓ Helped by ",U.helpedBy]})]})]})]}),t.jsx("div",{className:"text-right",children:t.jsxs("p",{className:"text-sm",style:{color:"var(--color-text-gray)"},children:["👥 ",(U.partySize?.adults||0)+(U.partySize?.minors||0)," visitors"]})})]})},U.id))}),b.length>M&&t.jsxs("div",{className:"flex justify-center mt-4",children:[t.jsx("button",{onClick:()=>S(P-1),disabled:P===1,className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Previous"}),t.jsxs("span",{className:"mx-4",style:{color:"var(--color-text-gray)"},children:["Page ",P," of ",Math.ceil(b.length/M)]}),t.jsx("button",{onClick:()=>S(P+1),disabled:P*M>=b.length,className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Next"})]})]})}),F&&L&&t.jsx(um,{customer:L,onClose:()=>{$(!1),C(null)},onSave:Me})]})}const an=15;function hm({customerName:s,checkInId:d,authToken:i,onDone:u}){const[g,p]=f.useState([]),[x,N]=f.useState({}),[b,I]=f.useState(!1),[L,C]=f.useState(""),F=f.useRef(null),$=f.useRef({});f.useEffect(()=>{fetch(`/api/images/check-in/${d}`,{headers:{Authorization:`Bearer ${i}`}}).then(M=>M.json()).then(M=>{if(M.success&&Array.isArray(M.data)){p(M.data);const B={};M.data.forEach(X=>{B[X.id]=X.quantity}),N(B)}}).catch(()=>{})},[d,i]);const q=async M=>{const B=Array.from(M.target.files||[]);if(!B.length)return;const X=an-g.length,W=B.slice(0,X);if(W.length===0){C(`You've reached the maximum of ${an} images.`),F.current&&(F.current.value="");return}C(B.length>W.length?`Only ${W.length} image(s) added — ${an} image maximum.`:""),I(!0);const R=new FormData;W.forEach(E=>R.append("images",E)),R.append("quantities",JSON.stringify(W.map(()=>1)));try{const E=await fetch("/api/images/upload",{method:"POST",headers:{Authorization:`Bearer ${i}`},body:R}),K=await E.json();if(!E.ok)C(K.error||"Upload failed. Please try again.");else{const _=K.data;p(A=>[...A,..._]),N(A=>{const ee={...A};return _.forEach(ne=>{ee[ne.id]=ne.quantity}),ee})}}catch{C("Upload failed. Please check your connection.")}finally{I(!1),F.current&&(F.current.value="")}},k=f.useCallback((M,B)=>{N(X=>{const W=X[M]??1,R=Math.max(1,Math.min(99,W+B));return R===W?X:($.current[M]&&clearTimeout($.current[M]),$.current[M]=setTimeout(async()=>{try{await fetch(`/api/images/${M}/quantity`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:JSON.stringify({quantity:R})})}catch{}},600),{...X,[M]:R})})},[i]),P=async M=>{p(B=>B.filter(X=>X.id!==M)),N(B=>{const X={...B};return delete X[M],X});try{await fetch(`/api/images/${M}`,{method:"DELETE",headers:{Authorization:`Bearer ${i}`}})}catch{}},S=g.length>=an;return t.jsx("div",{className:"min-h-screen p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-2xl mx-auto",children:[t.jsxs("div",{className:"mb-8 text-center",children:[t.jsxs("h1",{style:{color:"var(--color-gold)"},children:["Welcome, ",s,"!"]}),t.jsx("p",{className:"mt-2",style:{color:"var(--color-text-gray)"},children:"Upload photos of materials you're interested in (optional)"})]}),t.jsxs("div",{className:"mb-4 text-center",children:[t.jsx("input",{ref:F,type:"file",accept:"image/*",multiple:!0,className:"hidden",onChange:q,disabled:b||S}),t.jsxs("button",{onClick:()=>F.current?.click(),disabled:b||S,className:"px-6 py-3 rounded-lg font-semibold",style:{display:"inline-flex",flexDirection:"row",alignItems:"center",gap:"8px",whiteSpace:"nowrap",backgroundColor:S?"var(--color-border)":"var(--color-gold)",color:S?"var(--color-text-gray)":"var(--color-background)",cursor:S?"not-allowed":"pointer"},children:[t.jsx(fh,{size:20}),b?"Uploading…":"Add Photos"]})]}),t.jsxs("p",{className:"mb-4 text-center",style:{color:"var(--color-text-gray)",fontSize:"14px"},children:[g.length," / ",an," images"]}),L&&t.jsx("div",{className:"mb-4 p-3 rounded-lg",style:{backgroundColor:"rgba(239,68,68,0.1)",border:"1px solid var(--color-error)"},children:t.jsx("p",{className:"text-center",style:{color:"var(--color-error)"},children:L})}),g.length>0&&t.jsx("div",{className:"space-y-3 mb-8",children:g.map(M=>t.jsxs("div",{className:"flex items-center gap-4 p-3 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("img",{src:M.image_url,alt:"Uploaded material",className:"rounded object-cover flex-shrink-0",style:{width:120,height:120}}),t.jsx("div",{className:"flex-1"}),t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("button",{onClick:()=>k(M.id,-1),className:"w-8 h-8 rounded-full flex items-center justify-center",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:t.jsx(wd,{size:14})}),t.jsx("span",{className:"w-8 text-center",style:{color:"var(--color-text-white)",fontWeight:600},children:x[M.id]??M.quantity}),t.jsx("button",{onClick:()=>k(M.id,1),className:"w-8 h-8 rounded-full flex items-center justify-center",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"},children:t.jsx(dn,{size:14})})]}),t.jsx("button",{onClick:()=>P(M.id),className:"w-8 h-8 rounded-full flex items-center justify-center ml-2",style:{backgroundColor:"rgba(239,68,68,0.1)",border:"1px solid var(--color-error)",color:"var(--color-error)"},children:t.jsx(ct,{size:16})})]},M.id))}),g.length===0&&!b&&t.jsxs("div",{className:"mb-8 py-12 text-center rounded-lg",style:{border:"2px dashed var(--color-border)"},children:[t.jsx(ys,{size:48,className:"mx-auto mb-3",style:{color:"var(--color-text-gray)"}}),t.jsx("p",{style:{color:"var(--color-text-gray)"},children:"No photos uploaded yet"})]}),t.jsx("button",{onClick:u,disabled:b,className:"w-full py-4 rounded-lg font-semibold",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)",opacity:b?.7:1},children:"Done"})]})})}function mm({checkInId:s,authToken:d,onDone:i}){const[u,g]=f.useState(0),[p,x]=f.useState(0),[N,b]=f.useState(""),[I,L]=f.useState(!1),[C,F]=f.useState(!1),[$,q]=f.useState(15),k=f.useRef(i);f.useEffect(()=>{k.current=i},[i]),f.useEffect(()=>{if(!C)return;const S=setInterval(()=>{q(M=>M<=1?(clearInterval(S),setTimeout(()=>k.current(),0),0):M-1)},1e3);return()=>clearInterval(S)},[C]);const P=async S=>{if(S){F(!0);return}if(u!==0){L(!0);try{await fetch("/api/survey",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({starRating:u,comment:N.trim()||void 0})})}catch{}finally{L(!1),F(!0)}}};return C?t.jsx("div",{className:"min-h-screen flex items-center justify-center p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-md text-center",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"48px"},children:[t.jsx(xs,{size:72,className:"mx-auto mb-6",style:{color:"var(--color-success)"}}),t.jsx("h1",{className:"mb-4",style:{color:"var(--color-gold)"},children:"Thank You!"}),t.jsx("p",{className:"mb-6",style:{color:"var(--color-text-white)",fontSize:"18px"},children:"We appreciate your feedback."}),t.jsxs("p",{style:{color:"var(--color-text-gray)"},children:["Returning to home screen in"," ",t.jsx("span",{style:{color:"var(--color-gold)"},children:$})," seconds…"]}),t.jsx("button",{onClick:()=>k.current(),className:"mt-6 px-8 py-4 rounded-lg",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Return Home"})]})}):t.jsx("div",{className:"min-h-screen flex items-center justify-center p-6",style:{backgroundColor:"var(--color-background)"},children:t.jsxs("div",{className:"w-full max-w-md",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",borderRadius:"12px",padding:"48px"},children:[t.jsx("h1",{className:"text-center mb-2",style:{color:"var(--color-gold)"},children:"How was your experience?"}),t.jsx("p",{className:"text-center mb-8",style:{color:"var(--color-text-gray)"},children:"Your feedback helps us improve."}),t.jsx("div",{className:"flex justify-center gap-3 mb-8",children:[1,2,3,4,5].map(S=>{const M=S<=(p||u);return t.jsx("button",{onClick:()=>g(S),onMouseEnter:()=>x(S),onMouseLeave:()=>x(0),className:"p-2 rounded-lg transition-transform",style:{background:"none",border:"none",transform:p===S?"scale(1.15)":"scale(1)",cursor:"pointer"},"aria-label":`${S} star${S!==1?"s":""}`,children:t.jsx(wl,{size:48,fill:M?"var(--color-gold)":"none",style:{color:M?"var(--color-gold)":"var(--color-border)"}})},S)})}),t.jsxs("div",{className:"mb-8",children:[t.jsx("label",{className:"block mb-2",style:{color:"var(--color-text-white)"},children:"Any additional feedback?"}),t.jsx("textarea",{value:N,onChange:S=>b(S.target.value),rows:4,placeholder:"Optional — share your thoughts…",className:"w-full px-4 py-3 rounded-lg resize-none",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)"}})]}),t.jsx("button",{onClick:()=>P(!1),disabled:I||u===0,className:"w-full py-4 rounded-lg mb-4 font-semibold",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)",opacity:I||u===0?.5:1,cursor:u===0?"not-allowed":"pointer"},children:I?"Submitting…":"Submit"}),t.jsx("div",{className:"text-center",children:t.jsx("button",{onClick:()=>P(!0),disabled:I,style:{color:"var(--color-text-gray)",background:"none",border:"none",cursor:"pointer",fontSize:"14px",textDecoration:"underline"},children:"Skip"})})]})})}function fm({rating:s}){return t.jsx("div",{className:"flex gap-0.5",children:[1,2,3,4,5].map(d=>t.jsx(wl,{size:16,fill:d<=s?"var(--color-gold)":"none",style:{color:d<=s?"var(--color-gold)":"var(--color-border)"}},d))})}function gm({onLogout:s}){const[d,i]=f.useState([]),[u,g]=f.useState(null),[p,x]=f.useState(1),[N,b]=f.useState(""),[I,L]=f.useState(""),[C,F]=f.useState(!1),[$,q]=f.useState(""),k=f.useCallback(async(B,X,W)=>{F(!0),q("");try{const R=new URLSearchParams({page:String(B)});X&&R.set("startDate",X),W&&R.set("endDate",W);const E=await fetch(`/api/survey/responses?${R}`),K=await E.json();E.ok?(i(K.data),g(K.meta)):q(K.error||"Failed to load responses.")}catch{q("Failed to load responses. Please check your connection.")}finally{F(!1)}},[]);f.useEffect(()=>{k(p,N,I)},[p,k]);const P=()=>{x(1),k(1,N,I)},S=()=>{b(""),L(""),x(1),k(1,"","")},M=u?Math.max(...[1,2,3,4,5].map(B=>u.distribution[B]??0),1):1;return t.jsxs("div",{className:"min-h-screen",style:{backgroundColor:"var(--color-background)"},children:[t.jsx("header",{style:{backgroundColor:"var(--color-card)",borderBottom:"1px solid var(--color-border)",padding:"16px 24px"},children:t.jsxs("div",{className:"max-w-6xl mx-auto flex items-center justify-between",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("img",{src:Jt,alt:"Reliance",className:"w-10 h-10 object-contain"}),t.jsxs("div",{children:[t.jsx("h2",{style:{color:"var(--color-gold)",margin:0},children:"Customer Ratings"}),t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"13px",margin:0},children:"Survey responses"})]})]}),t.jsxs("button",{onClick:s,className:"flex items-center gap-2 px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:[t.jsx(un,{size:16}),"Logout"]})]})}),t.jsxs("div",{className:"max-w-6xl mx-auto p-6 space-y-6",children:[u&&t.jsxs("div",{className:"grid gap-4",style:{gridTemplateColumns:"repeat(auto-fit, minmax(220px, 1fr))"},children:[t.jsxs("div",{className:"p-5 rounded-xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"13px",marginBottom:8},children:"Average Rating"}),t.jsxs("div",{className:"flex items-end gap-2",children:[t.jsx("span",{style:{color:"var(--color-gold)",fontSize:"40px",fontWeight:700,lineHeight:1},children:u.averageRating.toFixed(1)}),t.jsx(wl,{size:24,fill:"var(--color-gold)",style:{color:"var(--color-gold)",marginBottom:4}})]}),t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"13px",marginTop:4},children:"out of 5"})]}),t.jsxs("div",{className:"p-5 rounded-xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"13px",marginBottom:8},children:"Total Responses"}),t.jsx("span",{style:{color:"var(--color-text-white)",fontSize:"40px",fontWeight:700,lineHeight:1},children:u.total}),t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"13px",marginTop:4},children:"submissions"})]}),t.jsxs("div",{className:"p-5 rounded-xl",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",gridColumn:"span 2"},children:[t.jsx("p",{style:{color:"var(--color-text-gray)",fontSize:"13px",marginBottom:12},children:"Rating Distribution"}),t.jsx("div",{className:"space-y-2",children:[5,4,3,2,1].map(B=>{const X=u.distribution[B]??0,W=u.total>0?X/u.total*100:0,R=M>0?X/M*100:0;return t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsxs("div",{className:"flex items-center gap-1 flex-shrink-0",style:{width:80},children:[t.jsx("span",{style:{color:"var(--color-text-white)",fontSize:"13px",width:12,textAlign:"right"},children:B}),t.jsx(wl,{size:12,fill:"var(--color-gold)",style:{color:"var(--color-gold)"}})]}),t.jsx("div",{className:"flex-1 rounded-full overflow-hidden",style:{height:8,backgroundColor:"var(--color-background)"},children:t.jsx("div",{className:"h-full rounded-full",style:{width:`${R}%`,backgroundColor:"var(--color-gold)",transition:"width 0.3s ease"}})}),t.jsxs("span",{style:{color:"var(--color-text-gray)",fontSize:"12px",width:60,textAlign:"right"},children:[X," (",W.toFixed(0),"%)"]})]},B)})})]})]}),t.jsxs("div",{className:"p-4 rounded-xl flex flex-wrap items-end gap-4",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)"},children:[t.jsxs("div",{children:[t.jsx("label",{className:"block mb-1",style:{color:"var(--color-text-gray)",fontSize:"13px"},children:"From"}),t.jsx("input",{type:"date",value:N,onChange:B=>b(B.target.value),className:"px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",colorScheme:"dark"}})]}),t.jsxs("div",{children:[t.jsx("label",{className:"block mb-1",style:{color:"var(--color-text-gray)",fontSize:"13px"},children:"To"}),t.jsx("input",{type:"date",value:I,onChange:B=>L(B.target.value),className:"px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-white)",colorScheme:"dark"}})]}),t.jsx("button",{onClick:P,className:"px-5 py-2 rounded-lg font-semibold",style:{backgroundColor:"var(--color-gold)",color:"var(--color-background)"},children:"Apply"}),(N||I)&&t.jsx("button",{onClick:S,className:"px-4 py-2 rounded-lg",style:{backgroundColor:"var(--color-background)",border:"1px solid var(--color-border)",color:"var(--color-text-gray)"},children:"Clear"})]}),$&&t.jsx("div",{className:"p-3 rounded-lg",style:{backgroundColor:"rgba(239,68,68,0.1)",border:"1px solid var(--color-error)"},children:t.jsx("p",{style:{color:"var(--color-error)"},children:$})}),t.jsx("div",{className:"rounded-xl overflow-hidden",style:{border:"1px solid var(--color-border)"},children:t.jsxs("table",{className:"w-full",style:{borderCollapse:"collapse"},children:[t.jsx("thead",{children:t.jsx("tr",{style:{backgroundColor:"var(--color-card)",borderBottom:"1px solid var(--color-border)"},children:["Date","Customer","Rating","Comment"].map(B=>t.jsx("th",{className:"text-left px-4 py-3",style:{color:"var(--color-text-gray)",fontSize:"13px",fontWeight:600},children:B},B))})}),t.jsx("tbody",{children:C?t.jsx("tr",{children:t.jsx("td",{colSpan:4,className:"px-4 py-12 text-center",style:{color:"var(--color-text-gray)"},children:"Loading…"})}):d.length===0?t.jsx("tr",{children:t.jsx("td",{colSpan:4,className:"px-4 py-12 text-center",style:{color:"var(--color-text-gray)"},children:"No survey responses found."})}):d.map((B,X)=>t.jsxs("tr",{style:{backgroundColor:X%2===0?"var(--color-background)":"var(--color-card)",borderBottom:"1px solid var(--color-border)"},children:[t.jsx("td",{className:"px-4 py-3",style:{color:"var(--color-text-gray)",fontSize:"14px",whiteSpace:"nowrap"},children:new Date(B.createdAt).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})}),t.jsx("td",{className:"px-4 py-3",style:{color:"var(--color-text-white)",fontSize:"14px"},children:B.customerName}),t.jsx("td",{className:"px-4 py-3",children:t.jsx(fm,{rating:B.starRating})}),t.jsx("td",{className:"px-4 py-3",style:{color:"var(--color-text-gray)",fontSize:"14px",maxWidth:400},children:B.comment||t.jsx("span",{style:{fontStyle:"italic",opacity:.5},children:"No comment"})})]},B.id))})]})}),u&&u.totalPages>1&&t.jsxs("div",{className:"flex items-center justify-between",children:[t.jsxs("p",{style:{color:"var(--color-text-gray)",fontSize:"14px"},children:["Page ",u.page," of ",u.totalPages," · ",u.total," total"]}),t.jsxs("div",{className:"flex gap-2",children:[t.jsxs("button",{onClick:()=>x(B=>Math.max(1,B-1)),disabled:p<=1,className:"flex items-center gap-1 px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:p<=1?"var(--color-text-gray)":"var(--color-text-white)",cursor:p<=1?"not-allowed":"pointer",opacity:p<=1?.5:1},children:[t.jsx(Qp,{size:16})," Prev"]}),t.jsxs("button",{onClick:()=>x(B=>Math.min(u.totalPages,B+1)),disabled:p>=u.totalPages,className:"flex items-center gap-1 px-3 py-2 rounded-lg",style:{backgroundColor:"var(--color-card)",border:"1px solid var(--color-border)",color:p>=u.totalPages?"var(--color-text-gray)":"var(--color-text-white)",cursor:p>=u.totalPages?"not-allowed":"pointer",opacity:p>=u.totalPages?.5:1},children:["Next ",t.jsx(Kp,{size:16})]})]})]})]})]})}function xm(s){const d=s.materials||[],i=d.length>0||s.selectionSheetNumber||s.fabricator||s.draftStep>0;return{id:s.id,isRevisit:s.isRevisit||!1,firstName:s.firstName,lastName:s.lastName,street:s.street,suiteUnit:s.suiteUnit||"",city:s.city,state:s.state,zip:s.zip,country:s.country,phones:s.phones||[],emails:s.emails||[],referralSources:s.referralSources||[],signature:s.signature||"",checkInTime:new Date(s.checkInTime),helpedTime:s.helpedTime?new Date(s.helpedTime):void 0,status:s.status,currentlyHelpedBy:s.currentlyHelpedBy||void 0,partySize:s.partySize||{adults:1,minors:0},visitors:s.visitors||[],draft:i?{step:s.status==="helped"?3:s.draftStep||0,editedCustomerData:{},materials:d,selectedFabricator:s.fabricator||void 0,helpedBy:s.helpedBy||void 0,selectionSheetNumber:s.selectionSheetNumber||"",isHold:d.some(u=>u.hold)}:void 0}}function vm(){const[s,d]=f.useState(()=>{const Z=localStorage.getItem("staff2Session");if(Z)try{const{expiry:xe}=JSON.parse(Z);if(Date.now()<xe)return"staff2-dashboard"}catch{}return"home"}),[i,u]=f.useState({}),[g,p]=f.useState([]),[x,N]=f.useState(""),[b,I]=f.useState({adults:1,minors:0}),[L,C]=f.useState(!1),[F,$]=f.useState(null),[q,k]=f.useState([]),[P,S]=f.useState(0),[M,B]=f.useState([]),[X,W]=f.useState(!1),[R,E]=f.useState(null),[K,_]=f.useState(()=>{const Z=localStorage.getItem("staff2Session");if(Z)try{const{username:xe,expiry:je}=JSON.parse(Z);if(Date.now()<je)return xe;localStorage.removeItem("staff2Session")}catch{localStorage.removeItem("staff2Session")}return""}),[A,ee]=f.useState(null),[ne,pe]=f.useState(null);f.useEffect(()=>{fetch("/api/check-ins").then(Z=>Z.json()).then(Z=>{Z.success&&Array.isArray(Z.data)&&p(Z.data.map(xm))}).catch(Z=>console.error("Failed to load check-ins:",Z))},[]);const Ce=Z=>{u({...i,...Z,referralSources:[]}),d("customer-step3a")},Ee=Z=>{u({...i,...Z}),d("customer-step3a")},Me=Z=>{I(Z),d("customer-step3b")},Pe=Z=>{console.log("=== STEP 3B NEXT ==="),console.log("Signature data received:",{hasSignature:!!Z.signature,signatureLength:Z.signature?.length,signaturePreview:Z.signature?.substring(0,50),hasEsignConsent:!!Z.esignConsentTimestamp,sessionId:Z.sessionId,deviceType:Z.deviceInfo?.deviceType}),$(Z),b.adults>1?(S(0),k([]),d("customer-step3c")):b.minors>0?d("customer-step3d"):h(void 0,void 0,Z)},J=Z=>{const xe=[...q];xe[P]=Z,k(xe);const je=b.adults-2;P<je?S(P+1):b.minors>0?d("customer-step3d"):h(void 0,xe)},ce=()=>{P===0?d("customer-step3b"):S(P-1)},te=Z=>{console.log("=== STEP 3D SUBMIT ==="),console.log("Received names:",Z),console.log("Names length:",Z.length),h(Z)},h=async(Z,xe,je)=>{if(X)return;W(!0);const ke=Z!==void 0?Z:M,w=xe!==void 0?xe:q,se=je!==void 0?je:F,Qe=[{name:[i.firstName,i.lastName].filter(Boolean).join(" "),signature:se?.signature||"",isMain:!0,isMinor:!1},...w.map(Ue=>({name:Ue.name,signature:Ue.signature,isMain:!1,isMinor:!1})),...ke.map(Ue=>({name:Ue,signature:"",isMain:!1,isMinor:!0}))],Te={firstName:i.firstName,lastName:i.lastName,street:i.street,suiteUnit:i.suiteUnit||"",city:i.city,state:i.state,zip:i.zip,country:i.country,phones:i.phones,emails:i.emails,referralSources:i.referralSources||[],signature:se?.signature||"",partySize:b,visitors:Qe,checkInTime:new Date().toISOString(),esignConsentTimestamp:se?.esignConsentTimestamp,sessionId:se?.sessionId,deviceInfo:se?.deviceInfo};try{const Ue=await fetch("/api/check-ins",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Te)}),O=await Ue.json();if(!Ue.ok){console.error("Check-in API error:",O);let Re="Check-in failed. Please try again.";Ue.status===403?Re="Check-in is only available on the office network. Please connect to the office Wi-Fi.":Ue.status===409?(Re=O.error,d("customer-step1")):Ue.status===400&&(Re="Some information was invalid. Please review and re-enter your details.",d("customer-step1")),alert(Re),W(!1);return}console.log("Check-in successful:",O.data.id),O.data.waiverPdfUrl&&console.log("Waiver PDF:",O.data.waiverPdfUrl);const ge={id:O.data.id,...i,signatureData:se?.signature||"",checkInTime:new Date(O.data.checkInTime),status:"waiting",partySize:b,visitors:Qe};p([...g,ge])}catch(Ue){console.error("Check-in network error:",Ue),alert("Check-in failed. Please check your connection and try again."),W(!1);return}C(b.minors>0),I({adults:1,minors:0}),$(null),k([]),S(0),B([]),W(!1),d("customer-step4")},j=f.useCallback(()=>{u({}),C(!1),I({adults:1,minors:0}),$(null),k([]),S(0),B([]),d("home")},[]),oe=(Z,xe,je)=>{xe==="staff2"?br(Z):xe==="customer"&&je?(ee(je),d("customer-upload")):xe==="rating"?(N(Z),d("rating-dashboard")):(N(Z),d(xe==="pricing"?"pricing-dashboard":xe==="analysis"?"analysis-dashboard":"staff-dashboard"))},le=()=>{A&&pe({token:A.token,checkInId:A.checkInId}),ee(null),d("customer-survey")},U=()=>{pe(null),d("home")},Y=()=>{N(""),d("home")},de=Z=>{p(xe=>xe.map(je=>je.id===Z?{...je,status:"helped",helpedTime:new Date,currentlyHelpedBy:void 0}:je))},be=(Z,xe)=>{p(je=>je.map(ke=>ke.id===Z?{...ke,currentlyHelpedBy:xe}:ke))},ye=Z=>{p(xe=>xe.map(je=>je.id===Z?{...je,priced:!0,pricedTime:new Date}:je))},Oe=Z=>{p(xe=>xe.map(je=>je.id===Z?{...je,checkInTime:new Date}:je))},cr=Z=>{E(Z),d("revisit-step1")},Fr=Z=>{E(xe=>({...xe,...Z})),d("revisit-step2")},wr=Z=>{E(xe=>({...xe,referralSources:Z})),d("revisit-waiver")},Ve=async Z=>{if(X)return;W(!0);const xe={firstName:R.firstName,lastName:R.lastName,street:R.street,suiteUnit:R.suiteUnit||"",city:R.city,state:R.state,zip:R.zip,country:R.country,phones:R.phones,emails:R.emails,referralSources:R.referralSources||[],signature:Z.signature,partySize:Z.partySize,visitors:Z.visitors,checkInTime:new Date().toISOString(),isRevisit:!0};try{const je=await fetch("/api/check-ins",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(xe)}),ke=await je.json();if(!je.ok){je.status===403?alert("Check-in is only available on the office network. Please connect to the office Wi-Fi."):alert("Revisit check-in failed. Please try again."),W(!1);return}const w={id:ke.data.id,...R,isRevisit:!0,signature:Z.signature,checkInTime:new Date(ke.data.checkInTime),status:"waiting",partySize:Z.partySize,visitors:Z.visitors};p(se=>[...se,w])}catch{alert("Revisit check-in failed. Please check your connection."),W(!1);return}W(!1),d("revisit-confirmation")},br=Z=>{const xe=Date.now()+288e5;localStorage.setItem("staff2Session",JSON.stringify({username:Z,expiry:xe})),_(Z),d("staff2-dashboard")},jr=()=>{localStorage.removeItem("staff2Session"),_(""),d("home")},Lr=Z=>{p(xe=>xe.map(je=>je.id===Z?{...je,status:"done"}:je))},We=(Z,xe)=>{p(je=>je.map(ke=>ke.id===Z?{...ke,draft:xe}:ke))},or=Z=>{g.filter(ke=>ke.firstName===Z.firstName&&ke.lastName===Z.lastName&&ke.status==="helped"&&ke.draft?.selectionSheetNumber);let xe=Z.draft?.selectionSheetNumber||"";if(xe){const ke=xe.split("."),w=ke[0];if(ke.length===1)xe=`${w}.1`;else{const se=parseInt(ke[1])||0;xe=`${w}.${se+1}`}}const je={...Z,id:Date.now().toString(),checkInTime:new Date,status:"waiting",helpedTime:void 0,draft:{step:3,editedCustomerData:{},selectedFabricator:Z.draft?.selectedFabricator,materials:Z.draft?.materials||[],helpedBy:x,selectionSheetNumber:xe,isHold:!1,isRevisit:!0,previousMaterialsCount:(Z.draft?.materials||[]).length}};p([...g,je])},De=X?t.jsx(cn,{fullScreen:!0,color:"#ccb331",text:"Submitting your check-in…"}):null;if(s==="customer-step1")return t.jsxs(t.Fragment,{children:[De,t.jsx(Nh,{onNext:Ce,initialData:i})]});if(s==="customer-step2")return t.jsxs(t.Fragment,{children:[De,t.jsx(jh,{onNext:Ee,onBack:()=>d("customer-step1"),initialData:i})]});if(s==="customer-step3a")return t.jsxs(t.Fragment,{children:[De,t.jsx(Ch,{onNext:Me,onBack:()=>d("customer-step1"),initialData:b})]});if(s==="customer-step3b")return t.jsxs(t.Fragment,{children:[De,t.jsx(Eh,{onNext:Pe,onBack:()=>d("customer-step3a"),initialData:F||void 0})]});if(s==="customer-step3c"){const Z=P<q.length?q[P]:void 0;return t.jsxs(t.Fragment,{children:[De,t.jsx(Th,{onNext:J,onBack:ce,visitorNumber:P+2,totalAdults:b.adults,initialData:Z,primaryVisitorName:`${i.firstName??""} ${i.lastName??""}`.trim(),takenNames:q.slice(0,P).map(xe=>xe.name)},P)]})}return s==="customer-step3d"?t.jsxs(t.Fragment,{children:[De,t.jsx(zh,{onNext:te,onBack:()=>{b.adults>1?(S(b.adults-2),d("customer-step3c")):d("customer-step3b")},numberOfMinors:b.minors})]}):s==="customer-step4"?t.jsx(Mh,{customerName:[i.firstName,i.lastName].filter(Boolean).join(" "),hasMinors:L,onReturnHome:j}):s==="staff-login"?t.jsx(Oh,{onLogin:oe}):s==="staff-dashboard"?t.jsx(em,{username:x,onLogout:Y,checkIns:g,onMarkAsHelped:de,onSaveDraft:We,onRevisit:or,onUpdateCurrentlyHelpedBy:be}):s==="pricing-dashboard"?t.jsx(rm,{username:x,onLogout:Y,checkIns:g,fabricators:[],onComplete:ye,onResetHoldDate:Oe}):s==="analysis-dashboard"?t.jsx(tm,{username:x,onLogout:Y,checkIns:g,fabricators:[],onComplete:ye,onResetHoldDate:Oe}):s==="revisit-lookup"?t.jsx(om,{checkIns:g,onCustomerFound:cr,onBack:()=>d("home")}):s==="revisit-step1"?t.jsx(nm,{customerData:R,onNext:Fr,onBack:()=>d("revisit-lookup")}):s==="revisit-step2"?t.jsx(am,{referralSources:R?.referralSources||[],onNext:wr,onBack:()=>d("revisit-step1")}):s==="revisit-waiver"?t.jsxs(t.Fragment,{children:[De,t.jsx(sm,{customerName:[R?.firstName,R?.lastName].filter(Boolean).join(" "),onSubmit:Ve,onBack:()=>d("revisit-step2")})]}):s==="revisit-confirmation"?t.jsx(im,{customerName:[R?.firstName,R?.lastName].filter(Boolean).join(" "),onReturnHome:j}):s==="staff2-login"?t.jsx(cm,{onLogin:br}):s==="staff2-dashboard"?t.jsx(pm,{username:K,onLogout:jr,checkIns:g,onMarkAsDone:Lr}):s==="customer-upload"?A?t.jsx(hm,{customerName:A.customerName,checkInId:A.checkInId,authToken:A.token,onDone:le}):null:s==="customer-survey"?t.jsx(mm,{checkInId:ne?.checkInId??"",authToken:ne?.token??"",onDone:U}):s==="rating-dashboard"?t.jsx(gm,{onLogout:Y}):t.jsx(Fp,{onCustomerCheckIn:()=>d("customer-step1"),onStaffLogin:()=>d("staff-login"),onRevisit:()=>d("revisit-lookup"),onStaff2Login:()=>d("staff2-login")})}_p.createRoot(document.getElementById("root")).render(t.jsx(vm,{}));
